...
from PyQt6.QtGui import QPixmap, QBrush, QIcon,QPainter
...
class InputWithComboBox(QWidget):
    def __init__(self, options=None):
        ...
        self.combo_box.setFixedSize(60,23)
...
'''
    ...
    def __init__(self):
        ...
        self.tuichudenglu = QPushButton("退出")
        ...
        self.current_time_lunar_button.setGraphicsEffect(shadow)
        ...
        self.tuichudenglu.setFixedWidth(50)
        font = QFont('SimSun', 10)
        font.setBold(True)
        self.tuichudenglu.setFont(font)
        self.current_time_button.setFont(font)
        ...
        horizontal_layout.addWidget(self.current_time_lunar_button)
        ...
        grid_layout1.addWidget(self.TISHIYANG, 0, 0)
        grid_layout1.addWidget(self.time_entry1, 0, 1)
        grid_layout1.addWidget(self.time_entry1label, 0, 2)
        grid_layout1.addWidget(self.time_entry2, 0, 3)
        grid_layout1.addWidget(self.time_entry2label, 0, 4)
        grid_layout1.addWidget(self.time_entry3, 0, 5)
        grid_layout1.addWidget(self.time_entry3label, 0, 6)
        grid_layout1.addWidget(self.time_entry4, 0, 7)
        grid_layout1.addWidget(self.time_entry4label, 0, 8)
        grid_layout1.addWidget(self.time_entry5, 0, 9)
        grid_layout1.addWidget(self.time_entry5label, 0, 10)
        ...
        layout.addLayout(grid_layout1shuipingbuju)
        ...
        self.shuipingyinglishurushuchubuju.addWidget(self.TISHIYIN, 0, 0)
        ...
        self.shuipingyinglishurushuchubuju.addWidget(self.NIANSHUCHUKUANG_shuru, 0, 1)
        self.shuipingyinglishurushuchubuju.addWidget(self.nianlabel, 0, 2)
        self.shuipingyinglishurushuchubuju.addWidget(self.YUESHUCHUKUANG_shuru, 0, 3)
        self.shuipingyinglishurushuchubuju.addWidget(self.yuelabel, 0, 4)
        self.shuipingyinglishurushuchubuju.addWidget(self.RISHUCHUKUANG_shuru, 0, 5)
        self.shuipingyinglishurushuchubuju.addWidget(self.rilabel, 0, 6)
        self.shuipingyinglishurushuchubuju.addWidget(self.SHISHUCHUKUANG_shuru, 0, 7)
        self.shuipingyinglishurushuchubuju.addWidget(self.shilabel, 0, 8)
        self.shuipingyinglishurushuchubuju.addWidget(self.JIEQIYDSHUCHU_shuru, 0, 9)
        self.shuipingyinglishurushuchubuju.addWidget(self.jieqilabel, 0, 10)
        ...
        def replyyyy():
            ...
            reply.setWindowTitle("温馨提示")
            reply.setText(
                '输入👉：<font color=red>阴历</font> 年，月，日，时辰，节气(<font color=purple>注意两个历法只能选择一个输入，输入要完整，另一个需留白</font>)。')
            reply.setStandardButtons(QMessageBox.StandardButton.Ok)
            reply.exec()  # 阻塞应用程序直到用户关闭警告框
        ...
        for row in range(3):
            for col in range(3):
                ...
                if row == 1 and col == 1:
                    ...
                    out1 = QLineEdit()
                    out1.setReadOnly(True)
                    out1.setFixedSize(50, 30)  # 设置宽度和高度
                    ...
                    output1 = QLineEdit()
                    output1.setStyleSheet("background-color: white; color:red")
                    output1.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    ...
                    output3 = QLineEdit()
                    output3.setStyleSheet("background-color: white; color:red")
                    ...
                    output1.setStyleSheet("border: none;")
                    output2.setStyleSheet("border: none;")
                    output3.setStyleSheet("border: none;")
    ...
    def update_time(self):
        ...
        # 更新时间显示
        self.time_label.setText(f"温氏奇门\u3000当前时间: {current_time}")
    ...
    def show_info(self):
        ...
        if ye_lunar == "" and mo_lunar == "" and da_lunar == "" and ho_lunar == "" and jieqi_lunar == ""and ye == "" and mo == "" and da == "" and ho == "" and mi == "":
            reply = QMessageBox()
            style_sheet = """
                                            QMessageBox {
                                                background-color: rgb(173, 216, 230);
            ...
            reply.setStandardButtons(QMessageBox.StandardButton.Ok)
            reply.exec()  # 阻塞应用程序直到用户关闭警告框
        elif  ye_lunar == "" and mo_lunar == "" and da_lunar == "" and ho_lunar == "" and jieqi_lunar == "" and(ye or mo or da or ho or mi):
            if ye == "" or mo == "" or da == "" or ho == "" or mi == "":
                ...
                '''
                        ...
                        reply.setStandardButtons(QMessageBox.StandardButton.Ok)
                        reply.exec()  # 阻塞应用程序直到用户关闭警告框
        elif ye == "" and mo == "" and da == "" and ho == "" and mi == "" and (ye_lunar or mo_lunar or da_lunar or ho_lunar or jieqi_lunar) :
            ...
            reply.setText("请明确输入的是阴历还是阳历时间，如果选择阳历（阴历）输入，则阴历（阳历）输入框需留白。")
            reply.setStandardButtons(QMessageBox.StandardButton.Ok)
            reply.exec()  # 阻塞应用程序直到用户关闭警告框
