...
from PyQt6.QtGui import QPixmap, QColor, QBrush, QIcon,QAction
...
class TimeInfoApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(310, 30, 935, 780)  # 设置窗口大小和位置
        self.setFixedSize(935, 780)  # 设置窗口的固定大小
    ...
    def closeEvent(self, event):
        ...
        reply = QMessageBox.question(self, '用户提出退出请求', '确认退出吗？',
