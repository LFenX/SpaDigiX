...
from PyQt6.QtWidgets import QComboBox,QScrollArea,QGraphicsDropShadowEffect
...
#登录部分
        ...
        label3 = QLabel('XieWei LiFeng')
        label5 = QLabel('2023年9月')
        label4 = QLabel('电话: 13786866211 ')
        label6 = QLabel(' 邮箱: lfie2022@outlook.com')
        label1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        label2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        label3.setStyleSheet("color: red;")  # 设置文本颜色为红色
        label4.setStyleSheet("color: purple;")  # 设置文本颜色为红色
        label5.setStyleSheet("color: red;")  # 设置文本颜色为红色
        label6.setStyleSheet("color: purple;")  # 设置文本颜色为红色
        # 在登录部分上方添加一张图片
