...
from PyQt6.QtWidgets import QComboBox, QScrollArea, QGraphicsDropShadowEffect, QInputDialog, QSizePolicy, QSpacerItem,QSplashScreen
...
class TimeInfoApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(310, 30, 958, 790)  # 设置窗口大小和位置
        self.setFixedSize(958, 790)  # 设置窗口的固定大小
        base_path = getattr(sys, '_MEIPASS', os.path.abspath(os.path.dirname(__file__)))
        # 访问数据文件的路径
        ...
        self.gerenzhuye.setFixedWidth(20)
        icon = QIcon(image_path3)  # 替换成您的图标文件路径
        ...
        self.solar_label = QLabel(
            "输入：<font color='red'>阳历</font> 年，月，日，时间(<font color='purple'>可查范围：1900年1月30日0时0分至2100年12月31日23时59分</font>)；以下部分为输出内容")
        # 设置对齐方式为居中
        ...
        for row in range(3):
            for col in range(3):
                ...
                if row == 1 and col == 1:
                    ...
                    out1.setFixedSize(23, 30)  # 设置宽度和高度
                    out2.setFixedSize(23, 40)  # 设置宽度和高度
                    ...
                    inner_layout.addWidget(output1, 0, 2, 1, 3)  # 左上角
                    inner_layout.addWidget(output2, 1, 2, 1, 3)  # 中间
                    ...
                    text2 = QLabel("寄二")
                    text2.setStyleSheet(" padding:8px;font-weight: bold;")
...
class LoginDialog(QDialog):
    def __init__(self):
        ...
        #self.setMinimumSize(background_size)
        # 设置窗口图标
    ...
    def register(self):
        ...
        if ok and code in self.register_codes and self.register_codes[code]:
            ...
            self.login_status_label.setText("注册失败，未输入注册代码或注册代码错误")
