        ...
        for row in range(3):
            for col in range(3):
                ...
                if row == 1 and col == 1:
                    ...
                    output1 = QLineEdit()
                    output1.setStyleSheet("background-color:rgb(192,192,192);color:red;border-radius: 22px;border: none;")
                    ...
                    output3 = QLineEdit()
                    output3.setStyleSheet("background-color: rgb(192,192,192); color:red;border-radius: 22px;border: none;")
