...
L = int(input("请输入连续天数："))
J = int(input("请输入间隔时长："))
dongwushengxiao=input("请输入指定动物生肖：")
...
for i in range(1, XOXO  + 1):
    ...
    for j in range(0, 12):
        ...
        dongwugongdingwei={"子":0,"寅":1,"丑":1,"卯":2,"辰":3,"巳":3,"午":4,"未":5,"申":5,"酉":6,"戌":7,"亥":7}
...
chaxunriqinian=int(input("年份："))
chaxunriqiyue=int(input("月份："))
chaxunriqiri=int(input("日期："))
...
while True:
    print("------------------------")
    print("继续查询请再次输入日期")
    chaxunriqinian = int(input("年份（输入-1终止程序）："))
