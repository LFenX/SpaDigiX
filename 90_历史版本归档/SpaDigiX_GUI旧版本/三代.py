...
class TimeInfoApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(310, 30, 943, 830)  # 设置窗口大小和位置
        self.setFixedSize(943, 830)  # 设置窗口的固定大小
        base_path = getattr(sys, '_MEIPASS', os.path.abspath(os.path.dirname(__file__)))
        # 访问数据文件的路径
        ...
        self.solar_label = QLabel(
            "输入：<font color='red'>阳历</font> 年，月，日，时间(<font color='purple'>可查范围：1900年2月1日0时0分至2100年12月31日23时59分</font>)；以下部分为输出内容")
        # 设置对齐方式为居中
