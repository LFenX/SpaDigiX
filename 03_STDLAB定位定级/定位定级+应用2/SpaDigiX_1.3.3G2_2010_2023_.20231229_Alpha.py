from functionSpadigiXAPPTHREEANDTHREEG2 import getdingjideshu
import pandas as pd
import os
import math
...
for year in range(2010, 2024):
    sheet_name = f"{year}香港"

    try:
        # 读取上传的文件，并指定工作表名称
        file_path = '定位2010_2023香港初始数据.xlsx'
...
# 保存所有结果到一个 Excel 文件中
output_file_path = '2010-2023年香港汇总定级结果表G2-General4-1230.xlsx'
