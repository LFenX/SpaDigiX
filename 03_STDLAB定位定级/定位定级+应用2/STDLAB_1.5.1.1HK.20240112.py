#基础编码4-灵数方案-利用香港G3修改而来
#取消天干五合和长生十二宫部分
from functionSpaDigiXAPPONE import getthebasicmessageofnineGrids
def gettheSpaDigiX_value(year, month , day , hour,dingweigong):
    ttttt = dingweigong
    year = int(year)
    month = int(month)
    day = int(day)
...
for i in range(0, 12):
    ...
    if riganzhi == "甲子" and shichengganzhi == "甲子":
        ...
        if riganzhi[0] == shichengganzhi[0]:
            ...
            hour = 2 * i
            break
zhishideshu=gettheSpaDigiX_value(year,month,day,hour,"值使")
print(f"值使用神-基础编码四得数(HK)：{zhishideshu}")
