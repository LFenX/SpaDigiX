...
if len(zhishigongtianpan)==1:
    ...
    try:
        ...
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + (tiandiwuxingliliangxiaozhangdingshu1 +  tiandiwuxingliliangxiaozhangdingshu4 )/2
...
if hour==hourr:
    ...
    for i in range(0, 9):
        if i == 4:
            ...
            if "生" in bamenpanbiezhishi:
                shengmendingwei_index = i  # 这个编号代表值使所在宫的代号
    for i in range(0, 9):
            if i == 4:
                pass
            else:
    ...
    if yueganzhi[1] == "丑" and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月癸亥日+1")
    if yueganzhi[1] == "丑" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月乙丑日+1")
    if yueganzhi[1] == "丑" and riganzhi == "乙丑"  and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月乙丑日,双干坤宫+1")
    if yueganzhi[1] == "丑" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("丑月戊辰日-1")
    if yueganzhi[1] == "丑" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月庚午日+1")
    if yueganzhi[1] == "丑" and riganzhi == "庚午" and zhifudingwei_index==0:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("丑月庚午日,值符坎宫+2")
    if yueganzhi[1] == "丑" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("丑月甲申日-1")
    if yueganzhi[1] == "丑" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月辛卯日+1")
    if yueganzhi[1] == "丑" and riganzhi == "辛卯"  and shuanggandingwei_index==5:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("丑月辛卯日,双干乾宫+1")
    if yueganzhi[1] == "寅" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("寅月癸巳日+1")
    if yueganzhi[1] == "寅" and riganzhi == "癸巳" and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("寅月癸巳日,双干坤宫+2")
    if yueganzhi[1] == "寅" and riganzhi == "癸巳" and zhishigongdingwei_index == 5:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("寅月癸巳日,值使乾宫+2")
    if yueganzhi[1] == "寅" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("寅月丙申日-1")
    if yueganzhi[1] == "寅" and riganzhi == "丙申" and shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("寅月丙申日，双干艮宫-1")
    if yueganzhi[1] == "寅" and riganzhi == "庚子" and zhishigongdingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("寅月庚子日，值使震宫-1")
    if yueganzhi[1] == "寅" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("寅月癸卯日+1")
    if yueganzhi[1] == "寅" and riganzhi == "乙巳" and shuanggandingwei_index == 1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("寅月乙已日，双干坤宫+1")
    if yueganzhi[1] == "寅" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("寅月丁未日-2")
    if yueganzhi[1] == "寅" and riganzhi == "丁未" and zhifudingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("寅月丁未日,值符艮宫-2")
    if yueganzhi[1] == "寅" and riganzhi == "庚戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("寅月庚戌日+1")
    if yueganzhi[1] == "寅" and riganzhi == "庚戌" and zhifudingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("寅月庚戌日，值符坤宫+2")
    if yueganzhi[1] == "寅" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("寅月壬子日+1")
    if yueganzhi[1] == "寅" and riganzhi == "壬子" and shuanggandingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("寅月壬子日，双干离宫+2")
    if yueganzhi[1] == "寅" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
        print("寅月己未日+4")
    if yueganzhi[1] == "寅" and riganzhi == "己未" and shuanggandingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("寅月己未日，双干离宫+2")
    if yueganzhi[1] == "卯" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("卯月甲子日-1")
    if yueganzhi[1] == "卯" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("卯月癸酉日-1")
    if yueganzhi[1] == "卯" and riganzhi == "癸酉" and zhifudingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("卯月癸酉日，值符震宫-1")
    if yueganzhi[1] == "卯" and riganzhi == "癸酉" and shengmendingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("卯月癸酉日，生门艮宫-2")
    if yueganzhi[1] == "卯" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("卯月戊寅日-1")
    if yueganzhi[1] == "卯" and riganzhi == "戊寅" and shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("卯月戊寅日，双干艮宫-2")
    if yueganzhi[1] == "卯" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("卯月庚辰日+1")
    if yueganzhi[1] == "卯" and riganzhi == "乙酉" and shuanggandingwei_index == 1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("卯月乙酉日，双干坤宫+1")
    ...
    if yueganzhi[1] == "卯" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("卯月己丑日+1")
    if yueganzhi[1] == "卯" and riganzhi == "己丑" and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("卯月己丑日，双干坤宫+2")
    if yueganzhi[1] == "卯" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("卯月壬辰日+1")
    if yueganzhi[1] == "卯" and riganzhi == "壬辰" and shuanggandingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("卯月壬辰日，双干离宫+1")
    if yueganzhi[1] == "辰" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("辰月丙申日+1")
    if yueganzhi[1] == "辰" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("辰月己亥日+1")
    if yueganzhi[1] == "辰" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("辰月辛丑日-2")
    if yueganzhi[1] == "辰" and riganzhi == "辛丑" and zhishigongdingwei_index==0:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("辰月辛丑日，值使坎宫-2")
    if yueganzhi[1] == "辰" and riganzhi == "辛丑" and zhifudingwei_index==3:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("辰月辛丑日，值符巽宫-2")
    ...
    if yueganzhi[1] == "辰" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("辰月戊申日-1")
    if yueganzhi[1] == "辰" and riganzhi == "戊申" and zhifudingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("辰月戊申日，值符艮宫-2")
    if yueganzhi[1] == "辰" and riganzhi == "庚戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("辰月庚戌日-2")
    if yueganzhi[1] == "辰" and riganzhi == "庚戌" and  zhishigongdingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("辰月庚戌日，值使震宫-1")
    if yueganzhi[1] == "辰" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("辰月癸丑日+1")
    if yueganzhi[1] == "辰" and riganzhi == "癸丑" and shuanggandingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("辰月癸丑日，双干离宫+1")
    if yueganzhi[1] == "辰" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("辰月乙卯日-1")
    if yueganzhi[1] == "辰" and riganzhi == "乙卯" and shengmendingwei_index==3:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("辰月乙卯日，生门巽宫-1")
    if yueganzhi[1] == "己" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("己月甲子日+1")
    if yueganzhi[1] == "己" and riganzhi == "甲子" and shengmendingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("己月甲子日，生门乾宫+2")
    if yueganzhi[1] == "己" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("己月己巳日-1")
    if yueganzhi[1] == "己" and riganzhi == "辛巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("己月辛巳日-1")
    if yueganzhi[1] == "己" and riganzhi == "辛巳" and zhifudingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("己月辛巳日，值符艮宫-1")
    if yueganzhi[1] == "己" and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("己月癸未日-1")
    if yueganzhi[1] == "己" and riganzhi == "癸未" and  shengmendingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("己月癸未日，生门艮宫-2")
    if yueganzhi[1] == "己" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("己月壬辰日+1")
    if yueganzhi[1] == "己" and riganzhi == "壬辰"  and shuanggandingwei_index==5:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("己月壬辰日，双干乾宫+1")
    if yueganzhi[1] == "午" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月乙未日-2")
    if yueganzhi[1] == "午" and riganzhi == "乙未" and shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月乙未日，双干艮宫-2")
    if yueganzhi[1] == "午" and riganzhi == "乙未" and shengmendingwei_index == 8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("午月乙未日，生门离宫-1")
    if yueganzhi[1] == "午" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月甲辰日+1")
    if yueganzhi[1] == "午" and riganzhi == "甲辰" and shengmendingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月甲辰日，生门兑宫+1")
    if yueganzhi[1] == "午" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月丙午日-2")
    if yueganzhi[1] == "午" and riganzhi == "丙午" and shuanggandingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月丙午日，双干震宫-2")
    if yueganzhi[1] == "午" and riganzhi == "丙午" and shengmendingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月丙午日，生门离宫-2")
    if yueganzhi[1] == "午" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月己酉日+1")
    if yueganzhi[1] == "午" and riganzhi == "己酉" and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月己酉日，双干坤宫+1")
    if yueganzhi[1] == "午" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月辛亥日+1")
    if yueganzhi[1] == "午" and riganzhi == "辛亥" and zhifudingwei_index==5:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("午月辛亥日，值符乾宫+2")
    if yueganzhi[1] == "午" and riganzhi == "辛亥" and shuanggandingwei_index == 0:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("午月辛亥日，双干坎宫+2")
    if yueganzhi[1] == "午" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("午月癸丑日-1")
    if yueganzhi[1] == "午" and riganzhi == "癸丑" and shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月癸丑日，双干艮宫-2")
    if yueganzhi[1] == "午" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月丙辰日+1")
    if yueganzhi[1] == "午" and riganzhi == "辛酉" and shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("午月辛酉日，双干艮宫-2")
    if yueganzhi[1] == "午" and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月癸亥日+1")
    if yueganzhi[1] == "午" and riganzhi == "癸亥" and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("午月癸亥日，双干坤宫+1")
    ...
    if yueganzhi[1] == "未" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("未月甲戌日+1")
    if yueganzhi[1] == "未" and riganzhi == "甲戌" and zhishigongdingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("未月甲戌日，值使离宫+2")
    if yueganzhi[1] == "未" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("未月己卯日-1")
    if yueganzhi[1] == "未" and riganzhi == "己卯" and zhishigongdingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("未月己卯日，值使震宫-1")
    if yueganzhi[1] == "未" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("未月甲申日-1")
    if yueganzhi[1] == "未" and riganzhi == "甲申" and shengmendingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("未月甲申日，生门兑宫-1")
    if yueganzhi[1] == "未" and riganzhi == "丙戌" and zhishigongdingwei_index == 1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("未月丙戌日，值使坤宫+1")
    if yueganzhi[1] == "申" and riganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("申月庚子日+1")
    if yueganzhi[1] == "申" and riganzhi == "庚子" and shengmendingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("申月庚子日，生门离宫+1")
    if yueganzhi[1] == "申" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("申月乙巳日+1")
    if yueganzhi[1] == "申" and riganzhi == "乙巳" and zhishigongdingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("申月乙巳日，值使坤宫+1")
    if yueganzhi[1] == "申" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("申月丁未日-1")
    if yueganzhi[1] == "申" and riganzhi == "丁未" and shengmendingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("申月丁未日，生门兑宫-1")
    if yueganzhi[1] == "申" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("申月丙辰日-1")
    if yueganzhi[1] == "申" and riganzhi == "丙辰" and zhishigongdingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("申月丙辰日，值使艮宫-2")
    if yueganzhi[1] == "申" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("申月丙寅日-1")
    if yueganzhi[1] == "酉" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("酉月庚辰日-1")
    if yueganzhi[1] == "酉" and riganzhi == "庚辰" and shuanggandingwei_index==3:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("酉月庚辰日，双干巽宫-2")
    if yueganzhi[1] == "酉" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("酉月丙申日+2")
    if yueganzhi[1] == "酉" and riganzhi == "丙申" and shuanggandingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("酉月丙申日，双干坤宫+1")
    if yueganzhi[1] == "戌" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("戌月乙已日+1")
    if yueganzhi[1] == "戌" and riganzhi == "乙巳" and zhishigongdingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("戌月乙已日，值使离宫+1")
    if yueganzhi[1] == "戌" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("戌月戊申日-1")
    if yueganzhi[1] == "戌" and riganzhi == "戊申" and zhifudingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("戌月戊申日，值符震宫-2")
    if yueganzhi[1] == "戌" and riganzhi == "庚戌" and shengmendingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("戌月庚戌日,生门坤宫+1")
    if yueganzhi[1] == "戌" and riganzhi == "甲子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("戌月甲子日+1")
    if yueganzhi[1] == "戌" and riganzhi == "甲子" and shengmendingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("戌月甲子日，生门离宫+2")
    if yueganzhi[1] == "亥" and riganzhi == "辛未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("亥月辛未日+1")
    if yueganzhi[1] == "亥" and riganzhi == "辛未" and zhishigongdingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("亥月辛未日，值使离宫+2")
    if yueganzhi[1] == "亥" and riganzhi == "辛未" and shuanggandingwei_index==0:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("亥月辛未日，双干坎宫+1")
    if yueganzhi[1] == "亥" and riganzhi == "戊寅" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月戊寅日-1")
    if yueganzhi[1] == "亥" and riganzhi == "戊寅" and zhifudingwei_index==2:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月戊寅日，值符震宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "戊寅" and shuanggandingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月戊寅日，双干兑宫-1")
    if yueganzhi[1] == "亥" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月庚辰日-1")
    if yueganzhi[1] == "亥" and riganzhi == "庚辰" and  shuanggandingwei_index==7:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月庚辰日，双干艮宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("亥月乙酉日+1")
    if yueganzhi[1] == "亥" and riganzhi == "乙酉" and zhifudingwei_index==8:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("亥月乙酉日，值符离宫+2")
    if yueganzhi[1] == "亥" and riganzhi == "乙酉" and zhishigongdingwei_index==1:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print("亥月乙酉日，值使坤宫+2")
    if yueganzhi[1] == "亥" and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月丁亥日-1")
    if yueganzhi[1] == "亥" and riganzhi == "丁亥" and shengmendingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月丁亥日，生门兑宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "丁亥" and shuanggandingwei_index == 5:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月丁亥日，双干乾宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月庚寅日-1")
    if yueganzhi[1] == "亥" and riganzhi == "庚寅" and zhishigongdingwei_index==3:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月庚寅日，值使巽宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "庚寅" and shuanggandingwei_index == 0:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("亥月庚寅日，双干坎宫-2")
    if yueganzhi[1] == "亥" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月壬辰日-1")
    if yueganzhi[1] == "亥" and riganzhi == "壬辰"  and shuanggandingwei_index==3:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月壬辰日，双干巽宫-1")
    if yueganzhi[1] == "亥" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月甲午日-1")
    if yueganzhi[1] == "亥" and riganzhi == "甲午" and zhishigongdingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("亥月甲午日，值使兑宫-1")
    if yueganzhi[1] == "子" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("子月己亥日-1")
    if yueganzhi[1] == "子" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("子月甲辰日-1")
    if yueganzhi[1] == "子" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print("子月丙午日-2")
    if yueganzhi[1] == "子" and riganzhi == "丙午" and shuanggandingwei_index==6:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("子月丙午日，双干兑宫-1")
    #2023年12月27日18时17分
#-----------------------------------------------------------------------------------------------------------------------
