...
def gettheSpaDigiX_value(year, month , day , hour,dingweigong):
    ...
    print("----------------------------------------------------------------------------------------------------------")
    print("7 节气调整（注意具体调整不会在此处显示出来")
    JQ=yinyangdun_ganzhi[5]
    if SpaDigiX_APPONE_Value==0:
        SpaDigiX_APPONE_Value=-0.001
    if shichengganzhi[1]=="子":
        if JQ=="小寒"  and yueganzhi[1]=="丑":
            if riganzhi[1]=="亥"  or riganzhi[1]=="子" or riganzhi[1]=="卯"  or riganzhi[1]=="午" or riganzhi[1]=="申" or riganzhi[1]=="巳" or riganzhi[1]=="未" or riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
        if JQ=="大寒" and yueganzhi[1]=="丑":
            if riganzhi[1]=="午" or riganzhi[1]=="酉" or riganzhi[1]=="子":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
        if JQ=="立春" and yueganzhi[1]=="寅":
            if riganzhi[1]=="辰" or riganzhi[1]=="丑" or riganzhi[1]=="未" or riganzhi[1]=="子" or  riganzhi[1]=="卯" or riganzhi[1]=="酉":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-4
        if JQ=="雨水" and yueganzhi[1]=="寅":
            if riganzhi[1]=="戌" or riganzhi[1]=="丑" or riganzhi[1]=="辰" or riganzhi[1]=="亥" or riganzhi[1]=="巳" or riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="酉":
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 8
        if JQ == "惊蛰" and yueganzhi[1] == "卯":
            if riganzhi[1] == "亥" or riganzhi[1] == "丑" or riganzhi[1] == "辰":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ=="春分" and yueganzhi[1]=="卯":
            if riganzhi[1]=="巳" or riganzhi[1]=="午" or riganzhi[1]=="酉" or  riganzhi[1]=="亥" or riganzhi[1]=="寅" or riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="清明":
            if riganzhi[1]=="巳" or riganzhi[1]=="未" or riganzhi[1]=="酉" or riganzhi[1]=="戌" or riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="卯" or riganzhi[1]=="辰" or riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="谷雨" and yueganzhi[1]=="辰":
            if riganzhi[1]=="酉" or riganzhi[1]=="戌" or riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="辰" or riganzhi[1]=="申":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="立夏" and yueganzhi[1]=="巳":
            if riganzhi[1]=="辰" or riganzhi[1]=="巳" or riganzhi[1]=="午" or riganzhi[1]=="未" or riganzhi[1]=="申" or riganzhi[1]=="酉" or riganzhi[1]=="戌" or riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="小满" and yueganzhi[1]=="巳":
            if riganzhi[1]=="酉" or riganzhi[1]=="戌" or riganzhi[1]=="亥" or riganzhi[1]=="子" or riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
        if JQ=="芒种" and yueganzhi[1]=="午":
            if riganzhi[1]=="申" or riganzhi[1]=="未" or riganzhi[1]=="亥" or riganzhi[1]=="子" or riganzhi[1]=="丑" or riganzhi[1]=="卯" or riganzhi[1]=="辰" or riganzhi[1]=="巳":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="夏至" and yueganzhi[1]=="午":
            if riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
        if JQ=="小暑" and yueganzhi[1]=="未":
            if riganzhi[1]=="卯" or riganzhi[1]=="午" or riganzhi[1]=="申" or riganzhi[1]=="戌" or riganzhi[1]=="亥" or riganzhi[1]=="寅" or riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="大暑" and yueganzhi[1]=="未":
            if riganzhi[1]=="未" or riganzhi[1]=="戌" or riganzhi[1]=="亥" or riganzhi[1]=="子" or riganzhi[1]=="巳" or riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="立秋" and yueganzhi[1]=="申":
            if riganzhi[1]=="戌" or riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="卯" or riganzhi[1]=="午" or riganzhi[1]=="未" or riganzhi[1]=="申":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="处暑" and yueganzhi[1]=="申":
            if riganzhi[1]=="未" or riganzhi[1]=="子" or riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="白露" and yueganzhi[1]=="酉":
            if riganzhi[1]=="亥" or riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="未":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
        if JQ=="秋分" and yueganzhi[1]=="酉":
            if riganzhi[1]=="子" or riganzhi[1]=="卯" or riganzhi[1]=="辰" or riganzhi[1]=="午" or riganzhi[1]=="未":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="申":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1
            elif riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+6
        if JQ=="寒露" and yueganzhi[1]=="戌":
            if riganzhi[1]=="午" or riganzhi[1]=="未" or riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="子":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
            elif riganzhi[1]=="巳":
                ...
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+9
            elif riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
            elif riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+4
        if JQ=="霜降" and yueganzhi[1]=="戌":
            if riganzhi[1]=="巳" or riganzhi[1]=="午" or riganzhi[1]=="申" or riganzhi[1]=="戌" or riganzhi[1]=="亥" or riganzhi[1]=="子" or riganzhi[1]=="寅" or riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+3
        if JQ=="立冬" and yueganzhi[1]=="亥":
            if riganzhi[1]=="戌" or riganzhi[1]=="子" or riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="小雪" and yueganzhi[1]=="亥":
            if riganzhi[1]=="亥" or riganzhi[1]=="辰" or riganzhi[1]=="巳":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="大雪" and yueganzhi[1]=="子":
            if riganzhi[1]=="丑" or riganzhi[1]=="寅" or riganzhi[1]=="卯" or riganzhi[1]=="巳" or riganzhi[1]=="午" or riganzhi[1]=="申" or riganzhi[1]=="戌" or riganzhi[1]=="子":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+4
        if JQ=="冬至" and yueganzhi[1]=="子":
            if riganzhi[1]=="巳" or riganzhi[1]=="申" or riganzhi[1]=="酉" or riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3

    elif shichengganzhi[1]=="午":
        if JQ=="小寒" and yueganzhi[1]=="丑":
            if riganzhi[1] in "子辰午申酉戌巳未亥":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1
            elif riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1
        if JQ == "大寒" and yueganzhi[1] == "丑":
            if riganzhi[1] in "辰午未申酉子丑":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+6
        if JQ == "立春" and yueganzhi[1] == "寅":
            if riganzhi[1] in "丑申子寅巳":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="未":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
        if JQ == "雨水" and yueganzhi[1] == "寅":
            if riganzhi[1] in "亥子丑申酉午未":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-6
        if JQ == "惊蛰" and yueganzhi[1] == "卯":
            if riganzhi[1] in "亥丑寅卯巳午戌":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ == "春分" and yueganzhi[1] == "卯":
            if riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value-5
            elif riganzhi[1]=="未":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
        if JQ == "清明" and yueganzhi[1] == "辰":
            if riganzhi[1] in "申酉子丑寅卯辰巳":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ == "谷雨" and yueganzhi[1] == "辰":
            if riganzhi[1] in "酉戌寅卯巳午":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value

        if JQ == "立夏" and yueganzhi[1] == "巳":
            if riganzhi[1] in "寅辰巳未酉":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="子":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
            elif riganzhi[1]=="丑":
        ...
        if JQ == "小满" and yueganzhi[1] == "巳":
            if riganzhi[1] in "卯午寅":
                ...
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
        if JQ == "芒种" and yueganzhi[1] == "午":
            if riganzhi[1] in "戌子寅辰未":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="申":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-10
        if JQ == "夏至" and yueganzhi[1] == "午":
            if riganzhi[1] in "丑卯辰巳午申未酉":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+5
        if JQ == "小暑" and yueganzhi[1] == "未":
            if riganzhi[1] in "卯巳申酉亥丑":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-5
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-4
        if JQ == "大暑" and yueganzhi[1] == "未":
            if riganzhi[1] in "戌亥丑卯辰":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1] == "申":
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        if JQ == "立秋" and yueganzhi[1] == "申":
            if riganzhi[1] in "戌亥丑卯未酉":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ == "处暑" and yueganzhi[1] == "申":
            if riganzhi[1] in "辰巳午未申酉戌子丑":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ == "白露" and yueganzhi[1] == "酉":
            if riganzhi[1] in "申戌子辰":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
        if JQ == "秋分" and yueganzhi[1] == "酉":
            if riganzhi[1] in "亥寅卯午":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+8

        if JQ == "寒露" and yueganzhi[1] == "戌":
            if riganzhi[1] in "寅辰午申酉亥":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+8
        if JQ == "霜降" and yueganzhi[1] == "戌":
            if riganzhi[1] in "巳未戌寅":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+9
        if JQ == "立冬" and yueganzhi[1] == "亥":
            if riganzhi[1] in "午未亥子寅":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
        if JQ == "小雪" and yueganzhi[1] == "亥":
            if riganzhi[1] in "酉亥子丑卯辰巳午":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="戌":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
        if JQ == "大雪" and yueganzhi[1] == "子":
            if riganzhi[1] in "亥子卯巳午申酉戌":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="丑":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-1
        if JQ == "冬至" and yueganzhi[1] == "子":
            if riganzhi[1] in "巳午申酉":
                SpaDigiX_APPONE_Value = -SpaDigiX_APPONE_Value
            elif riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-5
            elif riganzhi[1]=="卯":
    ...
    elif shichengganzhi[1]=="酉":
        if JQ=="小寒" and yueganzhi[1]=="丑":
            if riganzhi[1] in "辰戌丑未卯巳":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="申":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2

        if JQ=="大寒" and yueganzhi[1]=="丑":
            if riganzhi[1] in "辰巳午未丑卯":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value

        if JQ=="立春" and yueganzhi[1]=="寅":
            if riganzhi[1] in "辰巳午":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="未":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1

        if JQ=="雨水" and yueganzhi[1]=="寅":
            if riganzhi[1] in "子辰巳未":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="酉":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
            elif riganzhi[1]=="申":
        ...
        if JQ=="惊蛰" and yueganzhi[1]=="卯":
            if riganzhi[1] in "子辰巳未酉戌":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=='丑':
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+4
        if JQ=="春分" and yueganzhi[1]=="卯":
            if riganzhi[1] in "子卯巳午未酉戌辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
        if JQ=="清明" and yueganzhi[1]=="辰":
            if riganzhi[1] in "戌亥子丑卯":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="巳":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
        if JQ=="谷雨" and yueganzhi[1]=="辰":
            if riganzhi[1] in "子丑卯辰午未":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+10
        if JQ=="立夏" and yueganzhi[1]=="巳":
            if riganzhi[1] in "丑卯辰午戌亥":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="子":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-1
        if JQ=="小满" and yueganzhi[1]=="巳":
            if riganzhi[1] in "未戌子丑辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="卯":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
            elif riganzhi[1]=="巳":
        ...
        if JQ=="小暑" and yueganzhi[1]=="未":
            if riganzhi[1] in "巳未酉子丑":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="辰":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+4

        if JQ=="大暑" and yueganzhi[1]=="未":
            if riganzhi[1] in "戌亥子辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="未":
        ...
        if JQ=="立秋" and yueganzhi[1]=="申":
            if riganzhi[1] in "子寅辰巳申戌":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="亥":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2

        if JQ=="处暑" and yueganzhi[1]=="申":
            if riganzhi[1] in "申酉亥":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="寅":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
        if JQ=="白露" and yueganzhi[1]=="酉":
            if riganzhi[1] in "申酉戌寅卯辰":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="午":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1
        if JQ=="秋分" and yueganzhi[1]=="酉":
            if riganzhi[1] in "申子寅辰巳":
                SpaDigiX_APPONE_Value=-SpaDigiX_APPONE_Value
            elif riganzhi[1]=="酉":
                SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-2
            elif riganzhi[1]=="戌":
...
shichengduiying={0:"子",2:"丑",4:"寅",6:"卯",8:"辰",10:"巳",12:"午",14:"未",16:"申",18:"酉",20:"戌",22:"亥"}
shicheng=hour
for i in range(0,12):
    if shicheng==2*i:
        shicheng=shichengduiying[shicheng]
    else:
        pass
print(f"值使用神-基础编码四F1得数-{shicheng}时(HK/MC)：{zhishideshu}")
print("提示：")
print(f"双干在{hourrr}时")
for i in range(0, 12):
