def getlinianshuangganjiugongshuju(i):
    import pandas as pd
    ...
    df['标签'], df['双干程序'],df["年月日干支时间"] = zip(*df['日期'].apply(label_and_calculate))
    ...
    # Output file path
    output_file_path = f'定位香港{i}双干九宫分类结果1205版第四次修改.xlsx'
...
for i in range(2010,2024):
    getlinianshuangganjiugongshuju(i)