def getSpaDigiXdingweideshu(year , month , day , hour):
    ...
    if len(zhishigongtianpan) > 3:
        zhishigongtianpanlist = zhishigongtianpan.split("\n")
        if zhishigongtianpanlist[0] == "甲戌己" or zhishigongtianpanlist[1] == "甲戌己" or zhishigongtianpanlist[
            0] == "甲寅癸" or zhishigongtianpanlist[1] == "甲寅癸":
    ...
    if zhishigongbashen == "九地" or zhishigongbashen == "太阴" or zhishigongbashen == "六合":
        ...
        zhishigongbashenjishu = 0
    if (
            zhishigongtianpanjishu1 == 1 or zhishigongtianpanjishu2 == 1) and zhishigongbamenjishu == 1 and zhishigongbashenjishu == 1:
