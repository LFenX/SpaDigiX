def getshuangzhifenleilinianshuju(i):
    import pandas as pd
    ...
    # 创建并填充每个标签的工作表
    sheets_data = {f"{label}时": pd.DataFrame() for label in
    ...
    # 输出文件路径
    output_file_path = f'定位香港{i}双支分类结果1205版第四次修改.xlsx'
...
for i in range(2010,2024):
    getshuangzhifenleilinianshuju(i)