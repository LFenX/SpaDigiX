def gettheSpaDigiX_value(year, month , day , hour,dingweigong,shuanggan):
    ...
    if yueganzhi[1] == "申" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print("申月甲子日+1")
    if yueganzhi[1] == "酉" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print("酉月庚午日-1")
    ...
    #新增年规则
    niandata = {
        2010: {'子': 0, '丑': -0.3, '寅': -0.6, '卯': -0.6, '辰': 0.6, '巳': 0, '午': 0.8, '未': -0.6, '申': 0, '酉': 0,
               '戌': -0.3, '亥': 0},
        2011: {'子': -0.5, '丑': -0.5, '寅': -0.6, '卯': 0, '辰': -0.9, '巳': 0.1, '午': -0.3, '未': 0.8, '申': 0.3,
               '酉': 0, '戌': 1, '亥': 0.9},
        2012: {'子': 0.5, '丑': 0.7, '寅': 0.9, '卯': 0.7, '辰': -0.3, '巳': 0.9, '午': 1, '未': 1.1, '申': -0.3,
               '酉': 0, '戌': 0.2, '亥': 0.7},
        2013: {'子': 0.6, '丑': -0.3, '寅': 0.1, '卯': 0.3, '辰': 0, '巳': 0.3, '午': -0.4, '未': 0, '申': 0.2, '酉': 1,
               '戌': 0, '亥': 0.4},
        2014: {'子': -0.3, '丑': -1.2, '寅': -0.4, '卯': 0.5, '辰': 0.7, '巳': 0.8, '午': 0.3, '未': 0.3, '申': 0,
               '酉': 0, '戌': 0.9, '亥': 1},
        2015: {'子': 0, '丑': 0, '寅': 0, '卯': 0.5, '辰': 0, '巳': -1, '午': 0, '未': 0.3, '申': 0, '酉': 0.5,
               '戌': -0.5, '亥': 0},
        2016: {'子': -0.3, '丑': -0.5, '寅': -0.9, '卯': 0.5, '辰': 0.4, '巳': 0.1, '午': 0, '未': 0.5, '申': 0,
               '酉': 0.4, '戌': 0, '亥': 0.5},
        2017: {'子': -0.6, '丑': 0, '寅': 0.2, '卯': 0, '辰': 1, '巳': 0.7, '午': 0.7, '未': 1.1, '申': -0.6, '酉': 0.5,
               '戌': 0.5, '亥': 0},
        2018: {'子': 0, '丑': 0.9, '寅': -0.3, '卯': 0, '辰': 0, '巳': 0, '午': 0.9, '未': 0, '申': 0, '酉': -0.9,
               '戌': 0.9, '亥': 0.5},
        2019: {'子': -1, '丑': 0.4, '寅': 0, '卯': 0.7, '辰': 0.9, '巳': -0.7, '午': -1.1, '未': 0, '申': 0, '酉': -1.1,
               '戌': 0},
        2021: {'子': 0.2, '丑': 0.3, '寅': 0, '卯': -0.4, '辰': 0, '巳': 0, '午': 0.3, '未': 0, '申': 0, '酉': 1,
               '戌': 0.4, '亥': 0},
        2022: {'子': 0, '丑': -0.3, '寅': -0.6, '卯': -0.6, '辰': 0.6, '巳': 0, '午': 0.8, '未': -0.6, '申': 0, '酉': 0,
               '戌': -0.3, '亥': 0}
    }
    for key in niandata:
        if year==key:
            nianfenzidian=niandata[key]
            for keys in nianfenzidian:
                if yueganzhi[1]==keys:
                    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+nianfenzidian[keys]
                    print(f"9 年月支新增规则：{year}年{yueganzhi}月：{nianfenzidian[keys]}")

    '''
    #G2General1
    average_values = {'子': -0.11666666666666668, '丑': -0.0666666666666667, '寅': -0.18333333333333335, '卯': 0.1333333333333333, '辰': 0.25, '巳': 0.10000000000000002, '午': 0.25, '未': 0.2416666666666667, '申': -0.03333333333333333, '酉': 0.11666666666666665, '戌': 0.2333333333333333, '亥': 0.3333333333333333}

    for key in average_values:
        if yueganzhi[1]==key:
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + average_values[key]
            print(f"9 年月支新增规则：{yueganzhi}月：{average_values[key]}")
    # -----------------------------------------------------------------------------------------------------------------------
    '''
    '''
    #G2General2 
    oushunian={'子': -0.25, '丑': -0.11666666666666665, '寅': -0.15, '卯': 0.15, '辰': 0.26666666666666666, '巳': -0.09999999999999999, '午': -0.05000000000000001, '未': 0.26666666666666666, '申': -0.016666666666666663, '酉': 0.15, '戌': 0.11666666666666665, '亥': 0.21666666666666667}
    jishunian={'子': 0.016666666666666673, '丑': -0.016666666666666673, '寅': -0.21666666666666667, '卯': 0.11666666666666668, '辰': 0.2333333333333333, '巳': 0.30000000000000004, '午': 0.5499999999999999, '未': 0.21666666666666667, '申': -0.049999999999999996, '酉': 0.08333333333333333, '戌': 0.35000000000000003, '亥': 0.45}
    if year==2010 or year==2012 or year==2014 or year==2016 or year==2018 or year==2021:
        for key in jishunian:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + jishunian[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{jishunian[key]}")
    elif year==2011 or year==2013 or year==2015 or year==2017 or year==2019 or year==2022:
         for key in oushunian:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + oushunian[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{oushunian[key]}")

    '''
    '''
    #G2General3
    GL31={'子': -0.175, '丑': -0.17500000000000002, '寅': -0.35, '卯': 0.22499999999999998, '辰': 0.475, '巳': -0.07499999999999998, '午': -0.17500000000000002, '未': -0.024999999999999994, '申': 0.05, '酉': 0.07499999999999996, '戌': -0.075, '亥': 0.225}
    GL32={'子': -0.3, '丑': -0.35, '寅': -0.2, '卯': 0.024999999999999994, '辰': 0.19999999999999998, '巳': 0.4, '午': 0.25, '未': 0.55, '申': -0.075, '酉': 0.375, '戌': 0.7, '亥': 0.475}
    GL33={'子': 0.125, '丑': 0.325, '寅': 2.7755575615628914e-17, '卯': 0.15, '辰': 0.075, '巳': -0.024999999999999994, '午': 0.675, '未': 0.20000000000000004, '申': -0.075, '酉': -0.1, '戌': 0.07500000000000002, '亥': 0.3}

    if year==2010 or year==2013 or year==2016 or year==2019:
        for key in GL31:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL31[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL31[key]}")
    elif year == 2011 or year == 2014 or year == 2017 or year == 2021:
        for key in GL32:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL32[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL32[key]}")
    elif year == 2012 or year == 2015 or year == 2018 or year == 2022:
        for key in GL33:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL33[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL33[key]}")
    '''
    '''
    #G2General4
    GL41={'子': -0.09999999999999999, '丑': -0.19999999999999998, '寅': -0.43333333333333335, '卯': -0.033333333333333326, '辰': 0.4333333333333333, '巳': 0.26666666666666666, '午': 0.6666666666666666, '未': -0.09999999999999999, '申': 0.0, '酉': -0.3, '戌': 0.5, '亥': 0.5}
    GL42={'子': -0.5, '丑': -0.033333333333333326, '寅': -0.19999999999999998, '卯': 0.39999999999999997, '辰': 0.0, '巳': -0.5333333333333333, '午': -0.46666666666666673, '未': 0.3666666666666667, '申': 0.09999999999999999, '酉': -0.20000000000000004, '戌': 0.16666666666666666, '亥': 0.3}
    GL43={'子': 0.13333333333333333, '丑': 0.16666666666666666, '寅': 0.0, '卯': 0.26666666666666666, '辰': 0.03333333333333335, '巳': 0.3333333333333333, '午': 0.43333333333333335, '未': 0.5333333333333333, '申': -0.09999999999999999, '酉': 0.4666666666666666, '戌': 0.20000000000000004, '亥': 0.39999999999999997}
    GL44={'子': 0.0, '丑': -0.19999999999999998, '寅': -0.09999999999999998, '卯': -0.09999999999999999, '辰': 0.5333333333333333, '巳': 0.3333333333333333, '午': 0.3666666666666667, '未': 0.1666666666666667, '申': -0.13333333333333333, '酉': 0.5, '戌': 0.06666666666666667, '亥': 0.13333333333333333}
    if year==2010 or year==2014 or year==2018:
        for key in GL41:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL41[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL41[key]}")
    elif year == 2011 or year == 2015 or year == 2019:
        for key in GL42:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL42[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL42[key]}")
    elif year == 2012 or year == 2016 or year == 2021:
        for key in GL43:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL43[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL43[key]}")
    elif year == 2013 or year == 2014 or year == 2022:
        for key in GL44:
            if yueganzhi[1] == key:
                SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + GL44[key]
                print(f"9 年月支新增规则：{yueganzhi}月：{GL44[key]}")
    '''
    return  SpaDigiX_APPONE_Value