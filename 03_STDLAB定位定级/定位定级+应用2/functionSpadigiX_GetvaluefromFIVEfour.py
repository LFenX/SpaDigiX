def gettheSpaDigiX_value(year, month , day , hour,dingweigong,shuanggan):
    ...
    bashenshieryueliliangxiaozhangshuju = {
        "寅": {"值符": -0.5, "螣蛇": -0.5, "太阴": 0.5, "六合": -0.5, "白虎": 0.5, "玄武": 0.0, "九地": 0.5,
               "九天": 0.5},
        "卯": {"值符": -0.5, "螣蛇": -0.5, "太阴": 0.5, "六合": -0.5, "白虎": 0.5, "玄武": 0.0, "九地": 0.5,
               "九天": 0.5},
        "辰": {"值符": 0.5, "螣蛇": 0.0, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.5, "九地": -0.5,
               "九天": -0.5},
        "巳": {"值符": 0.0, "螣蛇": -0.5, "太阴": 0.5, "六合": 0.0, "白虎": 0.5, "玄武": 0.5, "九地": -0.5,
               "九天": 0.5},
        "午": {"值符": -0.5, "螣蛇": -0.5, "太阴": 0.5, "六合": 0.0, "白虎": 0.5, "玄武": 0.5, "九地": -0.5,
               "九天": 0.5},
        "未": {"值符": 0.5, "螣蛇": 0.0, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.5, "九地": -0.5,
               "九天": -0.5},
        "申": {"值符": 0.5, "螣蛇": 0.5, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": -0.5, "九地": 0.0,
               "九天": -0.5},
        "酉": {"值符": 0.5, "螣蛇": 0.0, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": -0.5, "九地": 0.0,
               "九天": -0.5},
        "戌": {"值符": 0.0, "螣蛇": 0.5, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.5, "九地": -0.5,
               "九天": -0.5},
        "亥": {"值符": -0.5, "螣蛇": 0.5, "太阴": 0.0, "六合": -0.5, "白虎": 0.0, "玄武": -0.5, "九地": 0.5,
               "九天": 0.0},
        "子": {"值符": -0.5, "螣蛇": 0.5, "太阴": 0.0, "六合": -0.5, "白虎": 0.0, "玄武": -0.5, "九地": 0.5,
               "九天": 0.0},
        "丑": {"值符": 0.5, "螣蛇": 0.0, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.5, "九地": -0.5,
               "九天": -0.5}
    }
    # 6.2 八神在九宫内力量消长
    bashenzaijiugongliliangxiaozhangshuju = {
        0: {"值符": 0.0, "螣蛇": 0.5, "太阴": -0.5, "六合": 0.0, "白虎": -0.5, "玄武": -0.5, "九地": 0.5, "九天": -0.5},
        1: {"值符": 0.5, "螣蛇": -0.5, "太阴": 0.0, "六合": 0.5, "白虎": 0.0, "玄武": 0.5, "九地": -0.5, "九天": 0.0},
        2: {"值符": -0.5, "螣蛇": 0.0, "太阴": 0.5, "六合": -0.5, "白虎": 0.5, "玄武": -0.5, "九地": 0.5, "九天": 0.5},
        3: {"值符": -0.5, "螣蛇": 0.0, "太阴": 0.5, "六合": -0.5, "白虎": 0.5, "玄武": -0.5, "九地": 0.5, "九天": 0.5},
        5: {"值符": 0.5, "螣蛇": 0.5, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.0, "九地": -0.5, "九天": -0.5},
        6: {"值符": 0.5, "螣蛇": 0.5, "太阴": -0.5, "六合": 0.5, "白虎": -0.5, "玄武": 0.0, "九地": -0.5, "九天": -0.5},
        7: {"值符": 0.0, "螣蛇": -0.5, "太阴": 0.0, "六合": 0.5, "白虎": 0.0, "玄武": 0.5, "九地": -0.5, "九天": 0.0},
        8: {"值符": -0.5, "螣蛇": -0.5, "太阴": 0.5, "六合": -0.5, "白虎": 0.5, "玄武": 0.5, "九地": 0.0, "九天": 0.5}
    }
    ...
    #双壬干
    if riganzhi[0]=="壬" and shichengganzhi[0]=="壬":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1
        print("双壬干日：1")
    print("以上显示的内容为全盘初判新增规则")
    ...
    def getjixiongge(SpaDigiX_APPONE_Value, zhishigongtianpan, zhishigongdipan):
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚":
            agengbing = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 5
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="丙" and riganzhi[0]=="丙" and xuntou=="甲申庚":
            agengbing = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚" and xuntou=="甲戌己":
            xingge = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0] == "己" and riganzhi[
            0] == "己" and xuntou == "甲申庚":
            xingge = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚" :
            xingge = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1:
            xingge = 1
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="癸" and riganzhi[0]=="癸" and xuntou=="甲寅癸" :
            dage = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚" :
            dage = 1
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0] == "壬" and riganzhi[
            0] == "壬" and xuntou=="甲辰壬":
            xiaoge = 1
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚" :
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0] == "庚" and riganzhi[
            0] == "庚" and xuntou=="甲申庚":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0] == "庚" and riganzhi[
            0] == "庚" :
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1:
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0] == "戊" and riganzhi[
            0] == "戊" and xuntou=="甲申庚":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 5
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and shichengganzhi[0]=="庚" and riganzhi[0]=="庚":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 5
        ...
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and xuntou=="甲申庚" and shichengganzhi[0]=="辛" and riganzhi[0]=="辛" and yueganzhi[0]=="辛":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 6
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and xuntou=="甲申庚" and shichengganzhi[0]=="辛" and riganzhi[0]=="辛":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 :
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        # 2.17.8 辛
        ...
        if len(zhishigongdipan) > 3:
            ...
            zhishigongdipanjishu = 0
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1   and xuntou=="甲辰壬":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value +2
        elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1:
        ...
        if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and xuntou=="甲寅癸":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -3
