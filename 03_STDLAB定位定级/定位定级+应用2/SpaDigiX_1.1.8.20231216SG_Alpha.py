...
tonggongjici=0
tonggongbayaosudingwei=[zhishigongdingwei_index,zhifugongdingwei_index,shengmendingwei_index,shichenggandingwei_index,rigandingwei_index,yuegandingwei_index,niangandingwei_index,jiaziwudingwei_index]
for i in range(0,8):
...
if len(zhishigongtianpanshuju)==3 and len(zhishigongdipanshuju)==3:
    ...
    if (zhishigongtianpanshujulist[0] in zhichongonelist or zhishigongtianpanshujulist[1] in zhichongonelist) and zhishigongdipanshuju in zhichongonelist:
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+zhichongone
    elif (zhishigongtianpanshujulist[0] in zhichongtwolist or zhishigongtianpanshujulist[1] in zhichongtwolist)  and zhishigongdipanshuju in zhichongtwolist:
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+zhichongone
    elif (zhishigongtianpanshujulist[0] in zhichongthreelist or zhishigongtianpanshujulist[1] in zhichongthreelist)  and zhishigongdipanshuju in zhichongthreelist:
        if riganzhi == "甲子":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        else:
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + zhichongone
    ...
    if zhishigongtianpanshuju in zhichongonelist and (zhishigongdipanshujulist[0] in zhichongonelist or zhishigongdipanshujulist[1] in zhichongonelist):
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+zhichongone
    elif zhishigongtianpanshuju in zhichongtwolist and (zhishigongdipanshujulist[0] in zhichongtwolist or zhishigongdipanshujulist[1] in zhichongtwolist):
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+zhichongone
    elif zhishigongtianpanshuju in zhichongthreelist and (zhishigongdipanshujulist[0] in zhichongthreelist or zhishigongdipanshujulist[1] in zhichongthreelist):
        if riganzhi == "甲子":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        else:
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + zhichongone
    ...
    if (zhishigongtianpanshujulist[0] in zhichongonelist or zhishigongtianpanshujulist[
        1] in zhichongonelist) and (zhishigongdipanshujulist[0] in zhichongonelist or zhishigongdipanshujulist[1] in zhichongonelist):
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + zhichongone
    if (zhishigongtianpanshujulist[0] in zhichongtwolist or zhishigongtianpanshujulist[1] in zhichongtwolist)  and (zhishigongdipanshujulist[0] in zhichongtwolist or zhishigongdipanshujulist[1] in zhichongtwolist):
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+zhichongone
    if (zhishigongtianpanshujulist[0] in zhichongthreelist or zhishigongtianpanshujulist[1] in zhichongthreelist) and (zhishigongdipanshujulist[0] in zhichongtwolist or zhishigongdipanshujulist[1] in zhichongthreelist):
        if riganzhi == "甲子":
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        else:
            SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + zhichongone
...
def getjixiongge(SpaDigiX_APPONE_Value,zhishigongtianpan,zhishigongdipan):
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="辛" and yueganzhi[0]=="辛" and riganzhi[0]=="辛" and shichengganzhi[0]=="辛":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+4
    elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and yueganzhi[0]=="辛" and riganzhi[0]=="辛" and shichengganzhi[0]=="辛":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+3
    elif zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1 and riganzhi[0]=="辛" and shichengganzhi[0]=="辛":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu1 == 1 and zhishigongdipanjishu == 1 and nianganzhi[0]=="丁" and yueganzhi[0]=="丁" and riganzhi[0]=="丁" and shichengganzhi[0]=="丁":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="庚" and yueganzhi[0]=="庚" and riganzhi[0]=="庚" and shichengganzhi[0]=="庚":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="癸" and yueganzhi[0]=="癸" and riganzhi[0]=="癸" and shichengganzhi[0]=="癸":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu1 == 1 and zhishigongdipanjishu == 1 and nianganzhi[0]=="乙" and yueganzhi[0]=="乙" and riganzhi[0]=="乙" and shichengganzhi[0]=="乙":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu1 == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="丙" and yueganzhi[0]=="丙" and riganzhi[0]=="丙" and shichengganzhi[0]=="丙":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if zhishigongbamen in xiongmen:
        ...
        bamenxiongjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="戊" and yueganzhi[0]=="戊" and riganzhi[0]=="戊" and shichengganzhi[0]=="戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="己" and yueganzhi[0]=="己" and riganzhi[0]=="己" and shichengganzhi[0]=="己":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
    ...
    if len(zhishigongdipan) > 3:
        ...
        zhishigongdipanjishu = 0
    if zhishigongtianpanjishu == 1 and zhishigongdipanjishu == 1  and nianganzhi[0]=="壬" and yueganzhi[0]=="壬" and riganzhi[0]=="壬" and shichengganzhi[0]=="壬":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 4
...
if len(zhishigongtianpan)==1:
    ...
    if len(zhishigongdipan)==1:
        ...
        if len(zhishigongdipanlist[1])==1:
            ...
            for key in tianpandingwei_dipan_dangongtianpangandingshu:
                if zhishigongdipangan2==key:
                    tiandiwuxingliliangxiaozhangdingshu2=tianpandingwei_dipan_dangongtianpangandingshu[key]
        tiandiwuxingliliangxiaozhangdingshu=(tiandiwuxingliliangxiaozhangdingshu1+tiandiwuxingliliangxiaozhangdingshu2)/2
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+tiandiwuxingliliangxiaozhangdingshu
elif len(zhishigongtianpan)==3:
    if zhishigongtianpan=="甲子戊":
        if zhishigongbashen=="值符":
    ...
    try:
        ...
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + (tiandiwuxingliliangxiaozhangdingshu1 + tiandiwuxingliliangxiaozhangdingshu3)/2
    except NameError:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + (tiandiwuxingliliangxiaozhangdingshu1 +  tiandiwuxingliliangxiaozhangdingshu3 )/2
...
if zhishigongjiuxing=="天蓬" and zhishigongdingwei_index==8 and (yueganzhi[1]=="巳" or yueganzhi[1]=="午"):
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-1
elif (zhishigongjiuxing=="天芮" or zhishigongjiuxing=="天禽" or zhishigongjiuxing=="天任" ) and zhishigongdingwei_index==0 and (yueganzhi[1]=="子" or yueganzhi[1]=="亥"):
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-1
elif (zhishigongjiuxing=="天冲" or zhishigongjiuxing=="天辅") and (zhishigongdingwei_index==1 or zhishigongdingwei_index==7) and (yueganzhi[1]=="丑" or yueganzhi[1]=="辰" or yueganzhi[1]=="未" or yueganzhi[1]=="戌"):
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-1
elif (zhishigongjiuxing=="天心" or zhishigongjiuxing=="天柱") and (zhishigongdingwei_index==2 or zhishigongdingwei_index==3) and (yueganzhi[1]=="寅" or yueganzhi[1]=="卯"):
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value -1
elif zhishigongjiuxing=="天英" and (zhishigongdingwei_index==6 or zhishigongdingwei_index==5) and (yueganzhi[1]=="申" or yueganzhi[1]=="酉"):
    SpaDigiX_APPONE_Value =SpaDigiX_APPONE_Value -1
else:
    # 各星力量
...
if zhishigongbashen=="值符" and (yueganzhi[1]=="丑" or yueganzhi[1]=="辰" or yueganzhi[1]=="未" or yueganzhi[1]=="戌") and (zhishigongdingwei_index==1 or zhishigongdingwei_index==7):
...
tian_gan_dict = {
    "乙": {
        "寅": -1, "卯": -1, "辰": -1, "巳": -1, "午": 0, "未": 1, "申": 2, "酉": 2, "戌": 1, "亥": -1, "子": -1, "丑": 1
    },
    "丙": {
        "寅": -1, "卯": -1, "辰": 0, "巳": -1, "午": -1, "未": -1, "申": 1, "酉": 1, "戌": 0, "亥": 2, "子": 1, "丑": 0
    },
    "丁": {
        "寅": -1, "卯": -1, "辰": 0, "巳": -1, "午": -1, "未": -1, "申": 1, "酉": 1, "戌": 0, "亥": 1, "子": 1, "丑": 0
    },
    "戊": {
        "寅": 1, "卯": 0, "辰": -1, "巳": 0, "午": -1, "未": -1, "申": 0, "酉": 0, "戌": -1, "亥": 1, "子": 1, "丑": -1
    },
    "己": {
        "寅": 0, "卯": 2, "辰": -1, "巳": -1, "午": -1, "未": -1, "申": -1, "酉": 0, "戌": -1, "亥": 1, "子": 1, "丑": -1
    },
    "庚": {
        "寅": -1, "卯": 1, "辰": 0, "巳": 1, "午": 2, "未": -1, "申": -1, "酉": -1, "戌": -1, "亥": 0, "子": 0, "丑": -1
    },
    "辛": {
        "寅": 1, "卯": 1, "辰": 0, "巳": 1, "午": 1, "未": -1, "申": -1, "酉": -2, "戌": 0, "亥": 0, "子": 0, "丑": 2
    },
    "壬": {
        "寅": 0, "卯": -1, "辰": 0, "巳": 0, "午": 0, "未": 1, "申": -2, "酉": -1, "戌": 2, "亥": -1, "子": -1, "丑": 2
    },
    "癸": {
        "寅": -1, "卯": 0, "辰": 0, "巳": 1, "午": 1, "未": 2, "申": -1, "酉": -1, "戌": 2, "亥": -1, "子": -1, "丑": 0
    }
}
if len(zhishigongtianpan)==1 or len(zhishigongtianpan)==3:
        ...
        if zhishigongtianpan[-1]==key:
            ...
            if len(zhishigongdipan) == 1 or len(zhishigongdipan) == 3:
                ...
                for i in range(0,2):
                    zhishigongdipanlist.append(zhishigongdipanganlist[i][-1])
            if key == "乙" and "庚" in zhishigongdipanlist:
                distll =  {"子": 0, "丑": -2, "寅": 1, "卯": 1, "辰": -1, "巳": 1, "午": 1, "未": 0, "申": -1, "酉": 0, "戌": 0, "亥": 0}
                changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
            elif key=="庚" and "乙" in zhishigongdipanlist:
                distll =  {"子": 0, "丑": -2, "寅": 1, "卯": 1, "辰": -1, "巳": 1, "午": 1, "未": 0, "申": -1, "酉": 0, "戌": 0, "亥": 0}
                changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
            elif key == "丙" and "辛" in zhishigongdipanlist:
                distll =  {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2,"午": 1, "未": 0, "申": -1, "酉": 0, "戌": -1, "亥": -1}
                changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
            elif key == "辛" and "丙" in zhishigongdipanlist:
                distll =  {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2,"午": 1, "未": 0, "申": -1, "酉": 0, "戌": -1, "亥": -1}
                changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
            elif key =="戊" and "癸" in zhishigongdipanlist:
                distll =  {"子": 1, "丑": 0, "寅": -1, "卯": -1, "辰": 0, "巳": -1,"午": -1, "未": 0, "申": 1, "酉": 1, "戌": 1, "亥": 1}
                changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
            elif key =="癸" and "戊" in zhishigongdipanlist:
                if yueganzhi[1] == "午" and zhishigongdingwei_index == 8:
                    distll = {"子": 1, "丑": 0, "寅": -1, "卯": -1, "辰": 0, "巳": -1, "午": 0, "未": 0, "申": 1, "酉": 1, "戌": 1, "亥": 1}
                    changshengshiergongtianganyuevalue = distll[yueganzhi[1]]
                elif yueganzhi[1] == "申" and zhishigongdingwei_index == 0:
    ...
    for key in tian_gan_dict:
        if zhishigongtianpanganlist[0][-1]==key:
            ...
            if len(zhishigongdipan) == 1 or len(zhishigongdipan) == 3:
                ...
                zhishigongdipanlist.append(zhishigongdipanganlist[0][-1])
            if key == "乙" and "庚" in zhishigongdipanlist:
                distll1 = {"子": 0, "丑": -2, "寅": 1, "卯": 1, "辰": -1, "巳": 1, "午": 1, "未": 0, "申": -1, "酉": 0,
                          "戌": 0, "亥": 0}
                ...
                distll1 = {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2, "午": 1, "未": 0, "申": -1, "酉": 0,
                          "戌": -1, "亥": -1}
                changshengshiergongtianganyuevalue1 = distll1[yueganzhi[1]]
            elif key == "辛" and "丙" in zhishigongdipanlist:
                distll1 = {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2, "午": 1, "未": 0, "申": -1, "酉": 0,
                ...
                distll1 = {"子": 1, "丑": 0, "寅": -1, "卯": -1, "辰": 0, "巳": -1, "午": -1, "未": 0, "申": 1, "酉": 1,
                          "戌": 1, "亥": 1}
                changshengshiergongtianganyuevalue1 = distll1[yueganzhi[1]]
            elif key == "癸" and "戊" in zhishigongdipanlist:
                if yueganzhi[1] == "午" and zhishigongdingwei_index == 8:
    ...
    for key in tian_gan_dict:
        if zhishigongtianpanganlist[1][-1]==key:
            ...
            if len(zhishigongdipan) == 1 or len(zhishigongdipan) == 3:
                ...
                zhishigongdipanlist.append(zhishigongdipanganlist[1][-1])
            if key == "乙" and "庚" in zhishigongdipanlist:
                distll12 = {"子": 0, "丑": -2, "寅": 1, "卯": 1, "辰": -1, "巳": 1, "午": 1, "未": 0, "申": -1, "酉": 0,
                           "戌": 0, "亥": 0}
                ...
                distll12 = {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2, "午": 1, "未": 0, "申": -1, "酉": 0,
                           "戌": -1, "亥": -1}
                changshengshiergongtianganyuevalue12 = distll12[yueganzhi[1]]
            elif key == "辛" and "丙" in zhishigongdipanlist:
                distll12 = {"子": -1, "丑": 1, "寅": 0, "卯": 0, "辰": 1, "巳": 2, "午": 1, "未": 0, "申": -1, "酉": 0,
                ...
                distll12 = {"子": 1, "丑": 0, "寅": -1, "卯": -1, "辰": 0, "巳": -1, "午": -1, "未": 0, "申": 1, "酉": 1,
                           "戌": 1, "亥": 1}
                changshengshiergongtianganyuevalue12 = distll12[yueganzhi[1]]
            elif key == "癸" and "戊" in zhishigongdipanlist:
                if yueganzhi[1] == "午" and zhishigongdingwei_index == 8:
                ...
                changshengshiergongtianganyuevalue12 = distll12[yueganzhi[1]]
    changshengshiergongtianganyuevalue=(changshengshiergongtianganyuevalue1+changshengshiergongtianganyuevalue12)/2
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+changshengshiergongtianganyuevalue
...
sanhejuliebiao=[{"申","子","辰"},{"寅","午","戌"},{"亥","卯","未"},{"己","酉","丑"},{"辰","戌","丑","未"}]
...
if nianganzhiyinsu[1]=="卯" and yueganzhiyinsu[1]=="卯" and riganzhiyinsu[1]=="亥" and shichengganzhiyinsu[1]=="未":
    SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-6
    print("年、月、日、时亥卯未双三合（卯、卯、亥、未）：-6")
elif  zhiliebiao==sanhejuliebiao[0] or zhiliebiao==sanhejuliebiao[1] or zhiliebiao==sanhejuliebiao[2] or zhiliebiao==sanhejuliebiao[3] or zhiliebiao==sanhejuliebiao[4]:
    if shirizhi==dizhiliuchong[0] or shirizhi==dizhiliuchong[1] or shirizhi==dizhiliuchong[2] or shirizhi==dizhiliuchong[3] or shirizhi==dizhiliuchong[4] or shirizhi==dizhiliuchong[5]:
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+0
        print("年月日时出现三合局有冲破：0")
    elif riyuezhi==dizhiliuchong[0] or riyuezhi==dizhiliuchong[1] or riyuezhi==dizhiliuchong[2] or riyuezhi==dizhiliuchong[3] or riyuezhi==dizhiliuchong[4] or riyuezhi==dizhiliuchong[5]:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print("年月日时出现三合局有冲破：0")
    elif nianyuezhi==dizhiliuchong[0] or nianyuezhi==dizhiliuchong[1] or nianyuezhi==dizhiliuchong[2] or nianyuezhi==dizhiliuchong[3] or nianyuezhi==dizhiliuchong[4] or nianyuezhi==dizhiliuchong[5]:
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print("年月日时出现三合局有冲破：0")
    else:
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-3
...
if YD=="阳遁":
    if nianganzhiyinsu[0]=="癸" and yueganzhiyinsu[0]=="癸" and  riganzhiyinsu=="癸己" and shichengganzhiyinsu[0]=="癸":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-7
        print("年癸干，月癸干，日癸己，时癸干：-7")
    elif nianganzhiyinsu[0] == "癸" and yueganzhiyinsu[0] == "癸" and riganzhiyinsu == "癸卯" and shichengganzhiyinsu[
        0] == "癸":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 4
        print("年癸干，月癸干，日癸卯，时癸干：-4")
    elif nianganzhiyinsu[0] == "癸" and yueganzhiyinsu == "癸寅" and riganzhiyinsu == "癸寅" and shichengganzhiyinsu[
        0] == "癸":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
    ...
    if yueganzhiyinsu=="甲寅" and shichengganzhiyinsu=="壬寅" and riganzhiyinsu[0]=="壬":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
        print("甲寅月，壬寅时，日壬干:2")
    ganlu={"甲":"寅","乙":"卯","丙":"巳","丁":"午","戊":"巳","己":"午","庚":"申","辛":"酉","壬":"亥","癸":"子"}
    ...
    if yueganzhiyinsu[0]==shichengganzhiyinsu[0] and shichengganzhiyinsu[0]==riganzhiyinsu[0] and yueganzhiyinsu[1]=="午" and shichengganzhiyinsu[1]=="午":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+2
