...
def process_excel(file_path, sheet_name, start_date, end_date, n, h):
    ...
    return df_filtered
# 调用函数并打印结果
file_path = 'MC2021-2023_dataforAPP1.4.2prediction.xlsx'  # 替换为您的文件路径
...
print("0. 不输出")
print("1. 输出")
choi = input("请选择操作 (0/1): ")
if choi=="0":
    aa=11
elif choi=="1":
    aa=111
    output_file_path = f'MC{qishiriqi}到{zhongzhiriqi}参数为n=={n}且h=={h}.xlsx'
