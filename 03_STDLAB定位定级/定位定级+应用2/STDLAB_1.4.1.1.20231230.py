...
# 读取 Excel 文件中的所有工作表
excel_file_path = '香港2010-2023完整数据生肖版.xlsx'
...
# 遍历每个工作表
for sheet_name, sheet_data in reversed(all_sheets.items()):
    # 删除除日期列、特列、地支列以外的所有列
...
result_df.to_excel('240106早更新-香港2010-2023庄家模型数据汇总.xlsx', index=False)