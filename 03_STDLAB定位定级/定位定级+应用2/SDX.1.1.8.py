from  F118  import getSpaDigiXdingweideshu
    ...
    for index, row in df.iterrows():
        ...
        for time_period, hour in time_dict.items():
            if time_period=="双支":
                ...
                df.at[index, "1全盘初判"] = value[1]
                df.at[index, "1.1内外遁"] = value[2]
                df.at[index, "1.2驿马"] = value[3]
                df.at[index, "1.3同边要素"] = value[4]
                df.at[index, "1.4空亡"] = value[5]
                df.at[index, "1.5支冲"] = value[6]
                df.at[index, "1.6甲子戊+吉门"] = value[7]
                df.at[index, "2吉凶格"] = value[8]
                df.at[index, "3天盘干"] = value[9]
                df.at[index, "4九星"] = value[10]
                df.at[index, "5八门"] = value[11]
                df.at[index, "6八神"] = value[12]
                df.at[index, "7长生十二宫"] = value[13]
...
output_file_path_updated_source = '规则细分数据双支.xlsx'
