from functionSpaDigiXAPPONEandTWO import getSpaDigiXdingweideshu
...
# Load the Excel file
file_path_source = '定位、定级验证灵数误差表.xlsx'
...
data_error_2_source_abs=pd.read_excel(file_path_source, sheet_name='澳门定位误差ABS', parse_dates=['日期'])
...
output_file_path_updated_source = '定位_定级验证灵数误差表_处理后_含误差.xlsx'
