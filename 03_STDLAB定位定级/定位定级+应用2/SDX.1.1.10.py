...
def calculate_and_label(date):
    ...
    yueganzhi=getthebasicmessageofnineGrids(year, month, day, hourr)[1][2]
    return value, label, nianyueriganzhi,yueganzhi

# 应用组合函数
df['双干程序'], df['标签'],df["年月日干支时间"],df["月干支"] = zip(*df['日期'].apply(calculate_and_label))
...
# 输出文件路径
output_file_path = '4_240110_2023双干分类结果香港1205版本.xlsx'
