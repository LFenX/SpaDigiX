...
def predict_values(df, df2):
    ...
    # 修改后的各个列表
    shang1yuce_relations = [(valuess['特'], "被生"), (valuess['六'], "生"), (valuess['二'], "被克")]
    shang2yuce_relations = [(valuess['nongliweihao'], "生"), (valuess['二'], "被克"), (valuess['gongliweihao'], "被生")]
    shang3yuce_relations = [(valuess['五'], "被克"), (valuess['六'], "生"), (valuess['特'], "被克")]
    shang4yuce_relations = [(valuess['gongliweihao'], "克"), (valuess['nongliweihao'], "克"), (valuess['一'], "被克")]
    shang5yuce_relations = [(valuess['三'], "生"), (valuess['nongliweihao'], "被生"), (valuess['五'], "被生")]
    shang6yuce_relations = [(valuess['六'], "生"), (valuess['nongliweihao'], "本我"), (valuess['一'], "生")]
    shangteyuce_relations = [(valuess['四'], "克"), (valuess['nongliweihao'], "生"), (valuess['三'], "克")]
    relationss = [
    ...
    for index in range(1, len(df)):
        ...
        shang1yuce_relations = [(values['特'], "被生"), (values['六'], "生"), (values['二'], "被克")]
        shang2yuce_relations = [(values['nongliweihao'], "生"), (values['二'], "被克"),
                                (values['gongliweihao'], "被生")]
        shang3yuce_relations = [(values['五'], "被克"), (values['六'], "生"), (values['特'], "被克")]
        shang4yuce_relations = [(values['gongliweihao'], "克"), (values['nongliweihao'], "克"), (values['一'], "被克")]
        shang5yuce_relations = [(values['三'], "生"), (values['nongliweihao'], "被生"), (values['五'], "被生")]
        shang6yuce_relations = [(values['六'], "生"), (values['nongliweihao'], "本我"), (values['一'], "生")]
        shangteyuce_relations = [(values['四'], "克"), (values['nongliweihao'], "生"), (values['三'], "克")]
...
# 创建一个新的 Excel 写入器
with pd.ExcelWriter('香港新尾号处理结果二阶段-高-2010-2024.xlsx') as writer:
    # 遍历所有工作表
