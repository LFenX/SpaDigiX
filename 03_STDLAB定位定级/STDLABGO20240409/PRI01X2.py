...
def resource_path(relative_path):
    ...
    try:
        ...
        # 正常的 Python 玐境
        base_path = os.path.abspath("澳门P3逐年数据")
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # 主布局
        self.setWindowTitle("01-新尾号模型-排干-低")
    ...
    def predict2(self):
        ...
        if chengshi == "澳门":
            shang1yuce_relations = [(shangte, "被克"), (shang4, "生"), (shang5, "克")]
            shang2yuce_relations = [(shang5, "本我"), (shang3, "被生"), (nongliweihao, "本我")]
            shang3yuce_relations = [(gongliweihao, "被生"), (shang1, "被生"), (shangte, "本我")]
            shang4yuce_relations = [(shang6, "被克"), (gongliweihao, "本我"), (shang4, "克")]
            shang5yuce_relations = [(shang5, "生"), (shang1, "被生"), (shang2, "生")]
            shang6yuce_relations = [(shang1, "被生"), (shang3, "生"), (shang5, "生")]
            shangteyuce_relations = [(shang1, "生"), (nongliweihao, "被克"), (shang4, "克")]

            # 香港规则
        elif chengshi == "香港":
            shang1yuce_relations = [(shang5, "被生"), (shangte, "生"), (shang2, "本我")]
            shang2yuce_relations = [(shangte, "克"), (shang5, "被生"), (nongliweihao, "克")]
            shang3yuce_relations = [(shang5, "克"), (shang6, "被克"), (shang5, "被生")]
            shang4yuce_relations = [(shang1, "生"), (gongliweihao, "被生"), (shangte, "被克")]
            shang5yuce_relations = [(nongliweihao, "本我"), (shang1, "被克"), (shang4, "被生")]
            shang6yuce_relations = [(shang1, "克"), (nongliweihao, "被生"), (shang6, "被克")]
            shangteyuce_relations = [(shang4, "生"), (shang6, "本我"), (shang1, "被生")]
        # if chengshi == "澳门":
    ...
    def predict3(self):
        ...
        # 澳门和香港的规则
        aomen_rules = [
            [(shang42, 180), (rigan, 180), (shang42, 0)],
            [(shang32, 0), (shang32, 60), (niangan, 60)],
            [(rigan, 180), (shang62, 0), (niangan, 120)],
            [(shang22, 0), (shang42, 60), (shang12, 0)],
            [(yuegan, 240), (shang52, 60), (rigan, 60)],
            [(shangte2, 180), (shang32, 60), (shang52, 120)],
            [(yuegan, 180), (shangte2, 180), (rigan, 180)]
        ]

        xianggang_rules = [
            [(shang22, 120), (niangan, 60), (shang62, 120)],
            [(shang52, 60), (shang22, 240), (niangan, 0)],
            [(rigan, 120), (yuegan, 0), (shang52, 240)],
            [(yuegan, 60), (shang12, 180), (shang32, 180)],
            [(rigan, 240), (niangan, 120), (shang12, 60)],
            [(rigan, 180), (niangan, 120), (shangte2, 180)],
            [(shang52, 180), (niangan, 60), (shang22, 180)]
        ]
