...
def predict_values(df, df2):
    ...
    # 修改后的各个列表
    shang1yuce_relations = [(valuess['二'], "被克"), (valuess['四'], "克"), (valuess['六'], "克")]
    shang2yuce_relations = [(valuess['三'], "克"), (valuess['五'], "被克"), (valuess['六'], "本我")]
    shang3yuce_relations = [(valuess['四'], "被克"), (valuess['六'], "克"), (valuess['nongliweihao'], "被克")]
    shang4yuce_relations = [(valuess['二'], "被生"), (valuess['一'], "被生"), (valuess['特'], "被克")]
    shang5yuce_relations = [(valuess['二'], "被克"), (valuess['五'], "被生"), (valuess['四'], "被生")]
    shang6yuce_relations = [(valuess['三'], "本我"), (valuess['gongliweihao'], "被克"), (valuess['六'], "被生")]
    shangteyuce_relations = [(valuess['二'], "本我"), (valuess['nongliweihao'], "被生"), (valuess['一'], "被克")]
    relationss = [
    ...
    for index in range(1, len(df)):
        ...
        shang1yuce_relations = [(values['二'], "被克"), (values['四'], "克"), (values['六'], "克")]
        shang2yuce_relations = [(values['三'], "克"), (values['五'], "被克"), (values['六'], "本我")]
        shang3yuce_relations = [(values['四'], "被克"), (values['六'], "克"), (values['nongliweihao'], "被克")]
        shang4yuce_relations = [(values['二'], "被生"), (values['一'], "被生"), (values['特'], "被克")]
        shang5yuce_relations = [(values['二'], "被克"), (values['五'], "被生"), (values['四'], "被生")]
        shang6yuce_relations = [(values['三'], "本我"), (values['gongliweihao'], "被克"), (values['六'], "被生")]
        shangteyuce_relations = [(values['二'], "本我"), (values['nongliweihao'], "被生"), (values['一'], "被克")]
...
# 创建一个新的 Excel 写入器
with pd.ExcelWriter('澳门新尾号处理结果二阶段-高-2020-2024.xlsx') as writer:
    # 遍历所有工作表
