def getdingjideshu(year,month,day,hour):
    ...
    while SpaDigiX_dingji_value > 4:
        SpaDigiX_dingji_value = SpaDigiX_dingji_value - 4
    print(f"{year}-{month}-{day}-{hour}-G3-1HK定级结果：{SpaDigiX_dingji_value}")
    nianyueriganzhi = getthebasicmessageofnineGrids(year, month, day, hour)[2]
    return SpaDigiX_dingji_value, rigandeshu, zhishideshu, zhifudeshu, shengmendeshu, nianyueriganzhi, riganzhi