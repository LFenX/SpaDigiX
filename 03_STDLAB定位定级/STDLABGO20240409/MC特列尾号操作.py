...
def predict_values(df, df2):
    ...
    # 修改后的各个列表
    shang1yuce_relations = [(valuess['特'], "被克"), (valuess['四'], "生"), (valuess['五'], "克")]
    shang2yuce_relations = [(valuess['五'], "本我"), (valuess['三'], "被生"), (valuess['nongliweihao'], "本我")]
    shang3yuce_relations = [(valuess['gongliweihao'], "被生"), (valuess['一'], "被生"), (valuess['特'], "本我")]
    shang4yuce_relations = [(valuess['六'], "被克"), (valuess['gongliweihao'], "本我"), (valuess['四'], "克")]
    shang5yuce_relations = [(valuess['五'], "生"), (valuess['一'], "被生"), (valuess['二'], "生")]
    shang6yuce_relations = [(valuess['一'], "被生"), (valuess['三'], "生"), (valuess['五'], "生")]
    shangteyuce_relations = [(valuess['一'], "生"), (valuess['nongliweihao'], "被克"), (valuess['四'], "克")]
    relationss = [
    ...
    for index in range(1, len(df)):
        ...
        shang1yuce_relations = [(values['特'], "被克"), (values['四'], "生"), (values['五'], "克")]
        shang2yuce_relations = [(values['五'], "本我"), (values['三'], "被生"), (values['nongliweihao'], "本我")]
        shang3yuce_relations = [(values['gongliweihao'], "被生"), (values['一'], "被生"), (values['特'], "本我")]
        shang4yuce_relations = [(values['六'], "被克"), (values['gongliweihao'], "本我"), (values['四'], "克")]
        shang5yuce_relations = [(values['五'], "生"), (values['一'], "被生"), (values['二'], "生")]
        shang6yuce_relations = [(values['一'], "被生"), (values['三'], "生"), (values['五'], "生")]
        shangteyuce_relations = [(values['一'], "生"), (values['nongliweihao'], "被克"), (values['四'], "克")]
...
def predict_values2(df):
    ...
    return predictions
file_path = '澳门2020-2024年原始数据.xlsx'
xls = pd.ExcelFile(file_path)
sheet_names = sorted(xls.sheet_names, key=lambda x: int(x))
# 创建一个新的 Excel 写入器
with pd.ExcelWriter('澳门新尾号处理结果二阶段-低-2020-2024.xlsx') as writer:
    # 遍历所有工作表
