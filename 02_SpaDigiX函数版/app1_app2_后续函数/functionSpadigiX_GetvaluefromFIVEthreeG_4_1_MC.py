def gettheSpaDigiX_value(year, month , day , hour,dingweigong,shigan,rigan):
    ...
    for i in range(0,9):
        zhishigongdipanjiaziwupanduan=ninegridsbasicmessage[i]["地盘"]
        if len(zhishigongdipanjiaziwupanduan) == 3:
            if zhishigongdipanjiaziwupanduan=="甲子戊":
                jiaziwuindex=i
        elif len(zhishigongdipanjiaziwupanduan)>3:
            zhishigongdipanjiaziwupanduanlist = zhishigongdipanjiaziwupanduan.split("\n")
            if zhishigongdipanjiaziwupanduanlist[0]=="甲子戊":
                jiaziwuindex=i
        else:
            pass
    if ttttt == "值使":
        for i in range(0, 9):
            if i == 4:
                ...
                if "使" in bamenpanbiezhishi:
                    ...
                    print(f"值使宫号：{zhishigongdingwei_index}")
    elif ttttt == "生门":
        for i in range(0, 9):
            if i == 4:
                pass
                ...
                if "生" in bamenpanbiezhishi:
                    zhishigongdingwei_index = i  # 这个编号代表值使所在宫的代号
                    print(f"生门宫号：{zhishigongdingwei_index}")
        ...
        for i in range(0, 9):
            if i == 4:
                ...
                if "值符" == bashenpanbie:
                    ...
                    print(f"值符宫号：{zhishigongdingwei_index}")
    elif ttttt == "时干":
        for i in range(0, 9):
            if i == 4:
                pass
                ...
                if len(tianpanganshuju) == 1 or len(tianpanganshuju) == 3:
                    if shigan == tianpanganshuju[-1]:
                        zhishigongdingwei_index = i
                        print(f"双干宫号：{zhishigongdingwei_index}")
                else:
                    tianpanganshuju_list = tianpanganshuju.split("\n")
                    if shigan == tianpanganshuju_list[0][-1] or shigan == tianpanganshuju_list[1][-1]:
                        zhishigongdingwei_index = i
    elif ttttt == "日干":
        for i in range(0, 9):
            if i == 4:
                ...
                tianpanganshuju = ninegridsbasicmessage[i]["天盘"]
                if len(tianpanganshuju) == 1 or len(tianpanganshuju) == 3:
                    if rigan == tianpanganshuju[-1]:
                        zhishigongdingwei_index = i
                        print(f"双干宫号：{zhishigongdingwei_index}")
                else:
                    tianpanganshuju_list = tianpanganshuju.split("\n")
                    if rigan == tianpanganshuju_list[0][-1] or rigan == tianpanganshuju_list[1][-1]:
                        zhishigongdingwei_index = i
    ...
    for i in shikongzifuchuang:
        kongwanglist.append(i)
    tonggongjici = 0
    tonggongwuyaosudingwei = [zhishigongdingwei_indexc, zhifugongdingwei_index, shengmendingwei_index,
                              shichenggandingwei_index, rigandingwei_index]
    for i in range(0, 5):
    ...
    print(f"1 全盘初判：{quanpanchupanjieguo}")
    ...
    yinyangjiujugonghao=jiaziwuindex
    ...
    #G4澳门定级-二级-60甲子_起局_干支月规则
    print("8 G4澳门定级-二级-60甲子_起局_干支月规则")
    #甲子
    if jiaziwuindex==3 and riganzhi == "甲子" and yueganzhi!="丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "甲子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "甲子" and yueganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 0 and riganzhi == "甲子" and yueganzhi != "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "甲子" and yueganzhi != "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    elif jiaziwuindex == 8 and riganzhi == "甲子" and yueganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #乙丑
    if jiaziwuindex == 1 and riganzhi == "乙丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "乙丑" and yueganzhi != "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 0 and riganzhi == "乙丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.9")

    if jiaziwuindex == 3 and riganzhi == "乙丑" and yueganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    if jiaziwuindex == 3 and riganzhi == "乙丑" and yueganzhi != "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 4 and riganzhi == "乙丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #丙寅
    if jiaziwuindex == 1 and riganzhi == "丙寅" and yueganzhi != "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 0 and riganzhi == "丙寅" and yueganzhi != "乙卯" and yueganzhi!="庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.8")

    if jiaziwuindex == 8 and riganzhi == "丙寅" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "丙寅" and yueganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #丁卯
    if jiaziwuindex == 2 and riganzhi == "丁卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "丁卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "丁卯" and yueganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "丁卯" and yueganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "丁卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 7 and riganzhi == "丁卯" and yueganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 0 and riganzhi == "丁卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #戊辰
    if jiaziwuindex == 2 and riganzhi == "戊辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 3 and riganzhi == "戊辰" and yueganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "戊辰" and yueganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 0 and riganzhi == "戊辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 4 and riganzhi == "戊辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #己巳
    if jiaziwuindex == 2 and riganzhi == "己巳" and yueganzhi != "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 6 and riganzhi == "己巳" and yueganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 0 and riganzhi == "己巳" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 1  and riganzhi == "己巳" and yueganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    #庚午
    if jiaziwuindex == 8 and riganzhi == "庚午" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.3")

    if jiaziwuindex == 1 and riganzhi == "庚午" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.3")

    if jiaziwuindex == 2 and riganzhi == "庚午" and yueganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 7 and riganzhi == "庚午" and yueganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 6 and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 0 and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.2")

    #辛未
    if jiaziwuindex == 8 and riganzhi == "辛未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.6
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.6")

    if jiaziwuindex == 2 and riganzhi == "辛未" and yueganzhi != "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "辛未" and yueganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 6 and riganzhi == "辛未" and yueganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 0 and riganzhi == "辛未" and yueganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 1 and riganzhi == "辛未" and yueganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.2")

    #壬申
    if jiaziwuindex == 8 and riganzhi == "壬申" and yueganzhi != "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.4
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.4")

    if jiaziwuindex == 0 and riganzhi == "壬申" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 2 and riganzhi == "壬申" and yueganzhi != "辛酉" and yueganzhi!="己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 2 and riganzhi == "壬申" and yueganzhi =="己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.5")

    #癸酉
    if jiaziwuindex == 8 and riganzhi == "癸酉" and yueganzhi != "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 1 and riganzhi == "癸酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 2 and riganzhi == "癸酉" and yueganzhi != "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 7 and riganzhi == "癸酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 6 and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #甲寅
    if jiaziwuindex == 6 and riganzhi == "甲寅" and yueganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 7 and riganzhi == "甲寅" and yueganzhi != "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 2 and riganzhi == "甲寅" and yueganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #乙卯
    if jiaziwuindex == 7 and riganzhi == "乙卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.1")

    if jiaziwuindex == 6 and riganzhi == "乙卯" and yueganzhi != "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.8")

    if jiaziwuindex == 6 and riganzhi == "乙卯" and yueganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 2 and riganzhi == "乙卯" and yueganzhi != "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 3 and riganzhi == "乙卯" and yueganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 1 and riganzhi == "乙卯" and yueganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #丙辰
    if jiaziwuindex == 0 and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 1 and riganzhi == "丙辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "丙辰" and yueganzhi == "壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 2 and riganzhi == "丙辰" and yueganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 3 and riganzhi == "丙辰" and yueganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 7 and riganzhi == "丙辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 6 and riganzhi == "丙辰" and yueganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    #丁巳
    if jiaziwuindex == 7 and riganzhi == "丁巳" and yueganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 0 and riganzhi == "丁巳" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "丁巳" and yueganzhi != "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 2 and riganzhi == "丁巳" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #戊午
    if jiaziwuindex == 2 and riganzhi == "戊午" and yueganzhi != "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 6 and riganzhi == "戊午" and yueganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "戊午" and yueganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "戊午" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.2")

    #己未
    if jiaziwuindex == 2 and riganzhi == "己未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.2")

    if jiaziwuindex == 5 and riganzhi == "己未" and yueganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 6 and riganzhi == "己未" and yueganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "己未" and yueganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 7 and riganzhi == "己未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #庚申
    if jiaziwuindex == 4 and riganzhi == "庚申" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "庚申" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2.5")

    if jiaziwuindex == 6 and riganzhi == "庚申" and yueganzhi != "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 2 and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #辛酉
    if jiaziwuindex == 4 and riganzhi == "辛酉" and yueganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "辛酉" and yueganzhi != "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    if jiaziwuindex == 2 and riganzhi == "辛酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "辛酉" and yueganzhi == "庚戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 5 and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2.1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2.1")

    #壬戌
    if yueganzhi[1]=="巳" and riganzhi=="壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{riganzhi}日,{yueganzhi[1]}月:+0.5")
    if jiaziwuindex == 6 and riganzhi == "壬戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "壬戌" and yueganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")
    ...
    if jiaziwuindex == 1 and riganzhi == "壬戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "壬戌" and yueganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    #癸亥
    if jiaziwuindex == 3 and riganzhi == "癸亥" and yueganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 6 and riganzhi == "癸亥" and yueganzhi != "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 4 and riganzhi == "癸亥" and yueganzhi != "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 7 and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "癸亥" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.5")
    ...
    if riganzhi=="甲戌":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 1.5
        print("甲戌日：+1.5")
    if jiaziwuindex == 5 and riganzhi == "甲戌" and yueganzhi != "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 7 and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "甲戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.3")

    if jiaziwuindex == 1 and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "甲戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.3")

    if jiaziwuindex == 2 and riganzhi == "甲戌" and yueganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #乙亥
    if riganzhi=="乙亥":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 2.6
        print("乙亥日：+2.6")
    if jiaziwuindex == 5 and riganzhi == "甲戌" and yueganzhi != "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.3")
    ...
    if jiaziwuindex == 6 and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #丙子
    if jiaziwuindex == 5 and riganzhi == "丙子" and yueganzhi =="己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.5")

    if jiaziwuindex == 5 and riganzhi == "丙子" and yueganzhi =="辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 7 and riganzhi == "丙子" and yueganzhi =="癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "丙子" and yueganzhi !="丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "丙子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.1")

    #丁丑
    if jiaziwuindex == 5 and riganzhi == "丁丑" and yueganzhi =="辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 7 and riganzhi == "丁丑" and yueganzhi =="癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "丁丑" and yueganzhi[1] =="未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "丁丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #戊寅
    if jiaziwuindex == 5 and riganzhi == "戊寅"and yueganzhi != "辛卯"and yueganzhi != "辛丑"and yueganzhi != "癸丑"and yueganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "戊寅" and yueganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "戊寅" and yueganzhi != "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 6 and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "戊寅" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #己卯
    if jiaziwuindex == 2 and riganzhi == "己卯" and yueganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 2 and riganzhi == "己卯" and yueganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 6 and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 4 and riganzhi == "己卯" and yueganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")
    ...
    if riganzhi=="庚辰":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+1.3
        print("庚辰日：+1.3")
    if jiaziwuindex == 2 and riganzhi == "庚辰" and yueganzhi != "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -1.6
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.6")

    if jiaziwuindex == 2 and riganzhi == "庚辰" and yueganzhi != "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.9")

    #辛巳
    if yueganzhi[1]=="酉" and  riganzhi=="辛巳":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value +1
        print(f"{riganzhi}日,{yueganzhi[1]}月:+1")

    if jiaziwuindex == 2 and riganzhi == "辛巳" and yueganzhi != "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 4 and riganzhi == "辛巳" and yueganzhi != "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "辛巳" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #壬午
    if jiaziwuindex == 4 and riganzhi == "壬午" and yueganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 6 and riganzhi == "壬午" and yueganzhi[1] == "未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 2 and riganzhi == "壬午" and yueganzhi!= "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.6")

    if jiaziwuindex == 5 and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #癸未
    if jiaziwuindex == 7 and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 3 and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 6 and riganzhi == "癸未" and yueganzhi== "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 4 and riganzhi == "癸未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.9")

    if jiaziwuindex == 2 and riganzhi == "癸未" and yueganzhi!= "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    #甲午
    if jiaziwuindex == 3 and riganzhi == "甲午" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.8")

    if jiaziwuindex == 1 and riganzhi == "甲午" and yueganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 6 and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.2")

    if jiaziwuindex == 4 and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+ 1")

    #乙未
    if yueganzhi[1]=="未" and riganzhi=="乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{riganzhi}日,{yueganzhi[1]}月:-2")

    if yueganzhi == "壬辰" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{riganzhi}日,{yueganzhi}月:-1")

    if yueganzhi == "丙申" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{riganzhi}日,{yueganzhi}月:-1")


    if jiaziwuindex == 3 and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 7 and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 5 and riganzhi == "乙未" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #丙申
    if jiaziwuindex == 7 and riganzhi == "丙申" and yueganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "丙申" and yueganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 3 and riganzhi == "丙申" and yueganzhi != "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #丁酉
    if jiaziwuindex == 8 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    if jiaziwuindex == 3 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.3")

    if jiaziwuindex == 1 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 5 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 6 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 4 and riganzhi == "丁酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.6")

    #戊戌
    if jiaziwuindex == 4 and riganzhi == "戊戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "戊戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.9")

    if jiaziwuindex == 3 and riganzhi == "戊戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.8")

    if jiaziwuindex == 7 and riganzhi == "戊戌" and yueganzhi == "甲寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 6 and riganzhi == "戊戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #己亥
    if jiaziwuindex == 2 and riganzhi == "己亥" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 8 and riganzhi == "己亥" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 6 and riganzhi == "己亥" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "己亥" and yueganzhi!="丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    #庚子
    if jiaziwuindex == 2 and riganzhi == "庚子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "庚子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 6 and riganzhi == "庚子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 0 and riganzhi == "庚子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.2")

    #辛丑
    if jiaziwuindex == 4 and riganzhi == "辛丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    if jiaziwuindex == 6 and riganzhi == "辛丑" and yueganzhi!="壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.2")

    if jiaziwuindex == 0 and riganzhi == "辛丑" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+ 1")

    if jiaziwuindex == 2 and riganzhi == "辛丑" and yueganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #壬寅
    if jiaziwuindex == 1 and riganzhi == "壬寅" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 2 and riganzhi == "壬寅" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 8 and riganzhi == "壬寅" and yueganzhi!="壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 4 and riganzhi == "壬寅" and yueganzhi != "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 6 and riganzhi == "壬寅" and yueganzhi != "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #癸卯
    if jiaziwuindex == 3 and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "癸卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 1 and riganzhi == "癸卯" and yueganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 6 and riganzhi == "癸卯" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 4 and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.2")

    if jiaziwuindex == 0 and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #甲申
    if jiaziwuindex == 2 and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.2")

    if jiaziwuindex == 1 and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #乙酉
    if jiaziwuindex == 0 and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "乙酉" and yueganzhi=="辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #丙戌
    if yueganzhi[1]=="未" and riganzhi=="丙戌":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 2
        print(f"{riganzhi}日,{yueganzhi[1]}月:+2")


    if jiaziwuindex == 4 and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 0 and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+3")

    if jiaziwuindex == 7 and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    #丁亥
    if jiaziwuindex == 4 and riganzhi == "丁亥" and yueganzhi[1]=="申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 0 and riganzhi == "丁亥" and yueganzhi[1]=="未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #戊子
    if jiaziwuindex == 4 and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 0 and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.1")

    if jiaziwuindex == 8 and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")


    #己丑
    if jiaziwuindex == 8 and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.2")

    if jiaziwuindex == 7 and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 5 and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2.2")

    if jiaziwuindex == 3 and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.6
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.6")

    #庚寅
    if jiaziwuindex == 1 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 6 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.8")

    if jiaziwuindex == 7 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.8
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.8")

    if jiaziwuindex == 3 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2.2")

    if jiaziwuindex == 2 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 0 and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    #辛卯
    if jiaziwuindex == 1 and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 3 and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.2")

    if jiaziwuindex == 5 and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.3")

    if jiaziwuindex == 7 and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.4
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.4")

    #壬辰
    #if nianganzhi[1]=="寅" and riganzhi=="壬戌":
       # SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value



    if jiaziwuindex == 6 and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "壬辰" and yueganzhi=="甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 2 and riganzhi == "壬辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.2")

    if jiaziwuindex == 0 and riganzhi == "壬辰" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.2")

    if jiaziwuindex == 5 and riganzhi == "壬辰" and yueganzhi[1]=="卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 1 and riganzhi == "壬辰" and yueganzhi=="壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    #癸巳
    if jiaziwuindex == 8 and riganzhi == "癸巳" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 7 and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")


    if jiaziwuindex == 2 and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 1 and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    #甲辰
    if jiaziwuindex == 7 and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 1 and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 3 and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 6 and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 2 and riganzhi == "甲辰" and yueganzhi=="壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #乙巳
    if jiaziwuindex == 2 and riganzhi == "乙巳" and yueganzhi[1]=="寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 7 and riganzhi == "乙巳" and yueganzhi=="壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 5 and riganzhi == "乙巳" and yueganzhi=="甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 6 and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 1 and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 0 and riganzhi == "乙巳" and yueganzhi=="壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    #丙午
    if jiaziwuindex == 2 and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 7 and riganzhi == "丙午" and yueganzhi!="甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 5 and riganzhi == "丙午" and yueganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 0 and riganzhi == "丙午" and yueganzhi=="壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 1 and riganzhi == "丙午" and yueganzhi=="甲寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 8 and riganzhi == "丙午" and yueganzhi=="戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    #丁未
    if jiaziwuindex == 7 and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.5")

    if jiaziwuindex == 2 and riganzhi == "丁未" and yueganzhi!="庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-2")

    if jiaziwuindex == 1 and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 0 and riganzhi == "丁未" and yueganzhi=="壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #戊申
    if jiaziwuindex == 2 and riganzhi == "戊申" and yueganzhi[1]!="戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.9")

    if jiaziwuindex == 6 and riganzhi == "戊申" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.3
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1.3")

    if jiaziwuindex == 1 and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 8 and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.9")

    if jiaziwuindex == 0 and riganzhi == "戊申" and yueganzhi=="甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 7 and riganzhi == "戊申" and yueganzhi=="壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #己酉
    if yueganzhi[1]=="辰" and riganzhi=="己酉":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 0.6
        print(f"{riganzhi}日,{yueganzhi[1]}月:+0.6")

    if jiaziwuindex == 0 and riganzhi == "己酉" and yueganzhi[1]=="子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "己酉" and yueganzhi[1]=="寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "己酉" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.9")

    #庚戌
    if yueganzhi[1]=="申" and riganzhi=="庚戌":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 0.4
        print(f"{riganzhi}日,{yueganzhi[1]}月：+0.4")

    if yueganzhi[1]=="午" and riganzhi=="庚戌" and yueganzhi!="甲午":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value + 2
        print(f"{riganzhi}日,{yueganzhi[1]}月：+2")


    if jiaziwuindex == 0 and riganzhi == "庚戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 8 and riganzhi == "庚戌" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    #辛亥
    if jiaziwuindex == 0 and riganzhi == "辛亥" and yueganzhi=="壬子" :
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    if jiaziwuindex == 4 and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1.5")

    if jiaziwuindex == 8 and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.1")

    #壬子
    if jiaziwuindex == 0 and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+0.5")

    if jiaziwuindex == 4 and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-0.5")

    if jiaziwuindex == 5 and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:-1")

    #癸丑
    if jiaziwuindex == 0 and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 2
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+2")

    if jiaziwuindex == 4 and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")

    if jiaziwuindex == 8 and riganzhi == "癸丑" and yueganzhi=="丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yinyangjiujugong},{riganzhi}日,{yueganzhi}月:+1")
