def getdingjideshu(year,month,day):
    from functionSpadigiX_GetvaluefromFIVEfive import gettheSpaDigiX_value
    ...
    while SpaDigiX_dingji_value > 4:
        SpaDigiX_dingji_value = SpaDigiX_dingji_value - 4
    return SpaDigiX_dingji_value,shuanggandeshu,zhishideshu,zhifudeshu,shengmendeshu