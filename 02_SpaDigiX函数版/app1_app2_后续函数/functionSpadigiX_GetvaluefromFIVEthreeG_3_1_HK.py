def gettheSpaDigiX_value(year, month , day , hour,dingweigong,shigan,rigan):
            ...
            if i == 4:
                ...
                if len(tianpanganshuju) == 1 or len(tianpanganshuju) == 3:
                    if shigan == tianpanganshuju[-1]:
                        zhishigongdingwei_index = i
                        print(f"时干宫号：{zhishigongdingwei_index}")
                else:
            ...
            if i == 4:
                ...
                if len(tianpanganshuju) == 1 or len(tianpanganshuju) == 3:
                    if rigan == tianpanganshuju[-1]:
                        zhishigongdingwei_index = i
                        print(f"日干宫号：{zhishigongdingwei_index}")
                else:
                    tianpanganshuju_list = tianpanganshuju.split("\n")
    ...
    zhishigongbamen=ninegridsbasicmessage[zhishigongdingwei_index]["八门"]
    jimen = ["开", "休", "生"]
    ...
    #G3新增规则
    #甲子日
    if yueganzhi[1]=="戌" and riganzhi=="甲子":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value-0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1]=="子" and riganzhi=="甲子":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value+0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1]=="午" and riganzhi=="甲子":
        SpaDigiX_APPONE_Value=SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[0]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "甲子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    # 乙丑日
    if yueganzhi[1] == "亥" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value +0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "乙丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙寅
    if yueganzhi[1] == "丑" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "丙寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丁卯
    if yueganzhi[1] == "卯" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丁卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊辰
    if yueganzhi[1] == "未" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "戊辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己巳
    if yueganzhi[1] == "卯" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "己巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #庚午
    if yueganzhi[1] == "丑" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "巳" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "亥" and riganzhi == "庚午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛未
    if yueganzhi[1] == "卯" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "辛未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬申
    if yueganzhi[1] == "未" and riganzhi == "壬申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "申" and riganzhi == "壬申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "壬申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "壬申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "壬申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #癸酉
    if yueganzhi[1] == "丑" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "癸酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #甲寅
    if yueganzhi[1] == "申" and riganzhi == "甲寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "甲寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "甲寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #乙卯
    if yueganzhi[1] == "丑" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "乙卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙辰
    if yueganzhi[1] == "寅" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "丙辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丁巳
    if yueganzhi[1] == "戌" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value +  0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "申" and riganzhi == "丁巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊午
    if yueganzhi[1] == "卯" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "寅" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "戊午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己未
    if yueganzhi[1] == "子" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "己未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #庚申
    if yueganzhi[1] == "辰" and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "巳" and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "庚申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛酉

    if yueganzhi[1] == "午" and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "辰" and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "辛酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬戌
    if yueganzhi[1] == "卯" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "亥" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")


    if yueganzhi[1] == "申" and riganzhi == "壬戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #癸亥
    if yueganzhi[1] == "子" and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "癸亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #甲戌
    if yueganzhi[1] == "亥" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "甲戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #乙亥
    if yueganzhi[1] == "巳" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "乙亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙子
    if yueganzhi[1] == "卯" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丙子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value  - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丁丑
    if yueganzhi[1] == "未" and riganzhi == "丁丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "丁丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "丁丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "丁丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊寅
    if yueganzhi[1] == "酉" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "戊寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己卯
    if yueganzhi[1] == "巳" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "己卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #庚辰
    if yueganzhi[1] == "丑" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "庚辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛巳
    if yueganzhi[1] == "卯" and riganzhi == "辛巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "辛巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "辛巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "辛巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬午
    if yueganzhi[1] == "未" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "壬午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")
    ...
    #癸未
    if yueganzhi[1] == "巳" and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "癸未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #甲午
    if yueganzhi[1] == "未" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "甲午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #乙未
    if yueganzhi[1] == "辰" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")
    ...
    if yueganzhi[1] == "申" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "乙未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙申
    if yueganzhi[1] == "午" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丙申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丁酉
    if yueganzhi[1] == "子" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")
    if yueganzhi[1] == "午" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")
    ...
    if yueganzhi[1] == "卯" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丁酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊戌
    if yueganzhi[1] == "申" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "戊戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己亥
    if yueganzhi[1] == "寅" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "己亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")
    ...
    #庚子
    if yueganzhi[1] == "午" and riganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "庚子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛丑
    if yueganzhi[1] == "寅" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "辛丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬寅
    if yueganzhi[1] == "午" and riganzhi == "壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "壬寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #癸卯
    if yueganzhi[1] == "申" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "癸卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #甲申
    if yueganzhi[1] == "卯" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value -0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "甲申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #乙酉
    if yueganzhi[1] == "亥" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "乙酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙戌
    if yueganzhi[1] == "酉" and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "丙戌":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")
    ...
    #丁亥
    if yueganzhi[1] == "丑" and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丁亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊子
    if yueganzhi[1] == "亥" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "戊子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己丑
    if yueganzhi[1] == "亥" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "己丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #庚寅
    if yueganzhi[1] == "辰" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "庚寅":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛卯
    if yueganzhi[1] == "未" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "辛卯":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬辰
    if yueganzhi[1] == "戌" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "壬辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #癸巳
    if yueganzhi[1] == "未" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "癸巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #甲辰
    if yueganzhi[1] == "辰" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "甲辰":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #乙巳
    if yueganzhi[1] == "午" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "乙巳":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丙午
    if yueganzhi[1] == "辰" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "丙午":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #丁未
    if yueganzhi[1] == "午" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "卯" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "丁未":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #戊申
    if yueganzhi[1] == "辰" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "戊申":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #己酉
    if yueganzhi[1] == "子" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "己酉":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.7
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #庚戊
    if yueganzhi[1] == "午" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "酉" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.4
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "庚戊":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #辛亥
    if yueganzhi[1] == "寅" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "辰" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.5
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "巳" and riganzhi == "辛亥":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.2
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #壬子
    if yueganzhi[1] == "辰" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "申" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "寅" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.3
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "戌" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.6
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "亥" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "丑" and riganzhi == "壬子":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value - 0.9
        print(f"{yueganzhi[1]}月{riganzhi}日")

    #癸丑
    if yueganzhi[1] == "戌" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "子" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 0.8
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "未" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")

    if yueganzhi[1] == "午" and riganzhi == "癸丑":
        SpaDigiX_APPONE_Value = SpaDigiX_APPONE_Value + 1
        print(f"{yueganzhi[1]}月{riganzhi}日")
    print("----------------------------------------------------------------------------------------------------------")
    print("----------------------------------------------------------------------------------------------------------")
