...
def getthebasicmessageofnineGrids(NIAN,YUE,RI,SHICHENG):
    ...
    shichengganzhi=shichengtiangan+shichengdizhi
    yinyangdun_ganzhi=[YD,nianganzhi,yueganzhi,riganzhi,shichengganzhi,JQ,zhishigongdingwei_index,zhishiluozhongwugongjikungong,xuntou]
    nianyueriganzhi=f"{nianganzhi}年，{yueganzhi}月，{riganzhi}日"
    return  dingweigong ,yinyangdun_ganzhi,nianyueriganzhi